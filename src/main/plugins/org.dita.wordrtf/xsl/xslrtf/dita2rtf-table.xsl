...
<xsl:template match="colspec[contains(@class, ' topic/colspec ')]"></xsl:template>

<xsl:template match="spanspec[contains(@class, ' topic/spanspec ')]"></xsl:template>
...
<xsl:if test="parent::thead[contains(@class, ' topic/thead ')]"><xsl:text>\trhdr </xsl:text></xsl:if>
...
\trftsWidth1\trautofit1\trpaddl108\trpaddr108\trpaddfl3\trpaddfr3</xsl:text>
  <xsl:apply-templates select="entry[contains(@class, ' topic/entry ')][1]" mode="emit-cell-style"/>
  <xsl:choose>
    <xsl:when test="parent::thead[contains(@class, ' topic/thead ')]"><xsl:text>\plain \s7\f4\fs24\b \qc</xsl:text></xsl:when>
...
<xsl:text>{</xsl:text><xsl:apply-templates select="entry[contains(@class, ' topic/entry ')][1]"/><xsl:text>}\row</xsl:text>
</xsl:template>
...
<xsl:template name="find-entry-start-position">
  <xsl:choose>
    ...
    <xsl:when test="@colname">
      ...
      <xsl:value-of select="number(count(../../../colspec[contains(@class, ' topic/colspec ')][@colname=current()/@colname]/preceding-sibling::*)+1)"/>
    </xsl:when>

    <!-- If the starting column is defined, check colspans to determine position -->
    <xsl:when test="@namest">
      <xsl:value-of select="number(count(../../../colspec[contains(@class, ' topic/colspec ')][@colname=current()/@namest]/preceding-sibling::*)+1)"/>
    </xsl:when>
    ...
    <xsl:when test="@spanname">
      ...
      <xsl:value-of select="number(count(../../../colspec[contains(@class, ' topic/colspec ')][@colname=$startspan]/preceding-sibling::*)+1)"/>
    </xsl:when>
...
<xsl:template name="find-entry-end-position">
  ...
  <xsl:choose>
    ...
    <xsl:when test="@nameend">
      <xsl:value-of select="number(count(../../../colspec[contains(@class, ' topic/colspec ')][@colname=current()/@nameend]/preceding-sibling::*)+1)"/>
    </xsl:when>
    <xsl:when test="@spanname">
      ...
      <xsl:value-of select="number(count(../../../colspec[contains(@class, ' topic/colspec ')][@colname=$endspan]/preceding-sibling::*)+1)"/>
    </xsl:when>
    <xsl:otherwise>
      <xsl:value-of select="$startposition"/>
    </xsl:otherwise>
...
<xsl:template name="find-spanspec-colspan">
  ...
  <xsl:variable name="startcolname">
    <xsl:value-of select="../../../spanspec[contains(@class, ' topic/spanspec ')][@spanname=$spanname][1]/@namest"/>
  </xsl:variable>
  <xsl:variable name="endcolname">
    <xsl:value-of select="../../../spanspec[contains(@class, ' topic/spanspec ')][@spanname=$spanname][1]/@nameend"/>
  </xsl:variable>
  <xsl:variable name="startpos">
   <xsl:value-of select="number(count(../../../colspec[contains(@class, ' topic/colspec ')][@colname=$startcolname]/preceding-sibling::*)+1)"/>
  </xsl:variable>
  <xsl:variable name="endpos">
   <xsl:value-of select="number(count(../../../colspec[contains(@class, ' topic/colspec ')][@colname=$endcolname]/preceding-sibling::*)+1)"/>
  </xsl:variable>
  <xsl:value-of select="$endpos - $startpos + 1"/>
</xsl:template>
  ...
  <xsl:template match="entry[contains(@class, ' topic/entry ')]" mode="emit-cell-style">
    ...
    <xsl:variable name="totalwidth">
      <xsl:choose>
        <xsl:when test="../../../colspec[contains(@class, ' topic/colspec ')]">
          <xsl:apply-templates select="../../../colspec[contains(@class, ' topic/colspec ')][1]" mode="count-rowwidth"/>
        </xsl:when>
    ...
    <xsl:variable name="thiswidth">
      <xsl:choose>
        <xsl:when test="../../../colspec[contains(@class, ' topic/colspec ')]">
          <xsl:apply-templates select="../../../colspec[contains(@class, ' topic/colspec ')][number($startpos)]" mode="count-colwidth">
    ...
    <xsl:variable name="left-to-right">
      <xsl:choose>
        <xsl:when test="../../../colspec[contains(@class, ' topic/colspec ')]">
      <xsl:apply-templates select="../../../colspec[contains(@class, ' topic/colspec ')][number($currentpos)]" mode="count-colwidth">
    ...
    <xsl:if test="following-sibling::entry[contains(@class, ' topic/entry ')] and $copy-style='false'">
      <xsl:apply-templates select="following-sibling::entry[contains(@class, ' topic/entry ')][1]" mode="emit-cell-style">
        <xsl:with-param name="left-border" select="$right-border"/>
        <xsl:with-param name="currentpos" select="$nextpos"/>
      </xsl:apply-templates>
    </xsl:if>
    <xsl:if test="not(following-sibling::entry[contains(@class, ' topic/entry ')]) and not($nextpos &gt; $col-max-num)">
      <!-- if this is the last entry in current row and next position is not greater than the number of columns in a row-->
      <xsl:call-template name="emit-vmerged-style">
        <xsl:with-param name="left-border" select="$right-border"/>
        <xsl:with-param name="startpos" select="$col-max-num + 1"/> <!-- make sure the remaining columns will be generated -->
  ...
  <xsl:template name="emit-vmerged-style">
    ...
    <xsl:text>\clvmrg</xsl:text>
      <xsl:apply-templates select="../preceding-sibling::*[entry[contains(@class, ' topic/entry ')][@morerows][@colnum=$currentpos or @colname=concat('col',$currentpos) or @namest=concat('col',$currentpos)]][1]/entry[contains(@class, ' topic/entry ')][@morerows][@colnum=$currentpos or @colname=concat('col',$currentpos) or @namest=concat('col',$currentpos)]" mode="emit-cell-style">
        <xsl:with-param name="left-border" select="$left-border"/>
