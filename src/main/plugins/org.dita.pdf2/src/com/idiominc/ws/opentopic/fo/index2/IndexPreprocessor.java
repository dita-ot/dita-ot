...
public final class IndexPreprocessor {
  ...
  private Node[] processCurrNode(
    ...
    if (checkElementName(theNode) && !excludedDraftSection.peek()) {
      ...
      for (int i = 0; i < childNodes.getLength(); i++) {
        final Node[] processedNodes = processCurrNode(
          childNodes.item(i),
          theTargetDocument,
  ...
  private Node[] processIndexNode(
    ...
    if (
      theNode.getAttributes().getNamedItem(elIndexRangeStartName) != null ||
   ...
   */
  private Node[] processIndexString(
    final String theIndexString,
  ...
  private Node[] transformToNodes(
    ...
    for (final IndexEntry indexEntry : theIndexEntries) {
      ...
      if (seeAlsoChildIndexEntries != null) {
        ...
        final Node[] seeAlsoNodes = transformToNodes(
          seeAlsoChildIndexEntries,
          theTargetDocument,
          theIndexEntryComparator
        );
