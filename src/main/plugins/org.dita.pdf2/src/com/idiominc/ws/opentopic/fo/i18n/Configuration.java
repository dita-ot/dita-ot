...
public class Configuration {
  ...
  public Configuration(final Document theConfigurationFile) throws ConfigurationException {
  ...
  private Alphabet[] initAlphabets(final Document theConfigurationFile) throws ConfigurationException {
  ...
  private Character[] processCharacterSetNode(final Node theNode) throws ConfigurationException {
