...
<!--
  Create a topic for each artist.
-->
<xsl:stylesheet version="2.0" 
  ...
  <xsl:template match="/">
    ...
    <map class="- map/map " id="artists">
      <title class="- topic/title ">Music library (by artist)</title>
        ...
        <xsl:choose>
          ...
          <xsl:otherwise>
            ...
            <xsl:variable name="filename">
              <xsl:call-template name="artistFilename"/>
            </xsl:variable>
            ...
            <topicref
                      ...
                      navtitle="{@artist}"
                      class="- map/topicref ">
              <xsl:apply-templates select="." mode="setCustomTopicrefAttrs-artist"/>
            </topicref>
