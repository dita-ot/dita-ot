...
public class XSDDescription extends XMLResourceIdentifierImpl 
    ...
    public boolean equals(Object descObj) {
        ...
        if (fNamespace != null)
        	...
        	if (desc.getLiteralSystemId() != null) 
        		return fLiteralSystemId.equals(desc.getLiteralSystemId()); //Fix for DITA XSD grammar cache
     ...
     */
    public int hashCode() {
         return (fNamespace == null) ? fLiteralSystemId.hashCode() : fNamespace.hashCode(); //Fix for DITA XSD grammar cache
    }
