...
public class RelaxNGDefaultsComponent
    implements XMLDocumentHandler, XMLComponent, XMLDocumentSource {
  ...
  /**
   * @see
   *     org.apache.xerces.xni.parser.XMLComponent#reset(org.apache.xerces.xni.parser.XMLComponentManager)
   */
  ...
  private void checkAndAddDefaults(QName name, XMLAttributes atts) {
    List<RelaxNGDefaultValues.Attribute> def =
        defaults.getDefaultAttributes(name.localpart, name.uri);
    if (def != null) {
        ...
        if (!alreadyDeclared) {
          ...
          if (a.namespace != null && a.namespace.length() > 0) {
            ...
            if (prefix != null && prefix.length() > 0) {
              ...
              // org.dita.dost.reader.MergeTopicParser.startElement(String, String, String,
              // Attributes)
  ...
  /**
   * @see org.apache.xerces.xni.XMLDocumentHandler#xmlDecl(java.lang.String, java.lang.String,
  ...
  /**
   * @see org.apache.xerces.xni.XMLDocumentHandler#doctypeDecl(java.lang.String, java.lang.String,
   *     java.lang.String, org.apache.xerces.xni.Augmentations)
   */
   ...
   */
  public void processingInstruction(String name, XMLString content, Augmentations arg2)
      throws XNIException {
   ...
   *
   * <p>Get a pseudo-attribute. This is useful only if the processing instruction data part uses
   * pseudo-attribute syntax, which it does not have to. This syntax is as described in the W3C
   * Recommendation "Associating Style Sheets with XML Documents".
   *
   * @param data The PI Data.
   * @param name The attr name.
   * @param unescapeValue True to unescape value before return
   ...
   * This method is copied from com.icl.saxon.ProcInstParser and used in the PIFinder
   *
   * <p>Interpret character references and built-in entity references
   */
  ...
  private void endElementToValidator(QName name) throws SAXException {
    validator
        .getContentHandler()
        .endElement(name.uri != null ? name.uri : "", name.localpart, name.rawname);
  ...
  public void startGeneralEntity(
      String arg0, XMLResourceIdentifier arg1, String arg2, Augmentations arg3)
      throws XNIException {
    if (documentHandler != null) {
  ...
  /**
   * @see org.apache.xerces.xni.XMLDocumentHandler#textDecl(java.lang.String, java.lang.String,
   *     org.apache.xerces.xni.Augmentations)
   */
  ...
  /**
   * @see
   *     org.apache.xerces.xni.XMLDocumentHandler#ignorableWhitespace(org.apache.xerces.xni.XMLString,
   *     org.apache.xerces.xni.Augmentations)
   */
  ...
  /**
   * @see
   *     org.apache.xerces.xni.XMLDocumentHandler#setDocumentSource(org.apache.xerces.xni.parser.XMLDocumentSource)
   */
  ...
  /**
   * @see
   *     org.apache.xerces.xni.parser.XMLDocumentSource#setDocumentHandler(org.apache.xerces.xni.XMLDocumentHandler)
   */
