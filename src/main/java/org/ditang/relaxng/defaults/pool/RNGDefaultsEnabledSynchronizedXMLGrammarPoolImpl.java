...
public class RNGDefaultsEnabledSynchronizedXMLGrammarPoolImpl
  ...
  /**
   * @see
   *     org.ditang.relaxng.defaults.pool.RNGDefaultsEnabledGrammarPool#getRngDefaultValues(java.lang.String)
   */
  @Override
  ...
  /**
   * @see
   *     org.ditang.relaxng.defaults.pool.RNGDefaultsEnabledGrammarPool#putRngDefaultValues(java.lang.String,
   *     org.ditang.relaxng.defaults.RelaxNGDefaultValues)
   */
  @Override
