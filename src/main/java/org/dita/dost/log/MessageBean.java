...
public final class MessageBean {
  ...
  @Deprecated
  public MessageBean(
      final String mbId, final String mbType, final String mbReason, final String mbResponse) {
    id = mbId;
   ...
   */
  public MessageBean(
      final String mbId, final Type mbType, final String mbReason, final String mbResponse) {
    id = mbId;
    type = mbType;
    reason = mbReason;
    response = mbResponse;
    ...
    if (locator.getSystemId() != null) {
      try {
        ...
        throw new RuntimeException(
            "Failed to parse URI '" + locator.getSystemId() + "': " + e.getMessage(), e);
      }
    }
