 ...
 * @since 2.2
 */
public record KeyScope(
    String id, String name, Map<String, KeyDef> keyDefinition, List<KeyScope> childScopes) {

  public static final String ROOT_ID = "#root";
  public static final KeyScope EMPTY =
      new KeyScope(ROOT_ID, null, Collections.emptyMap(), Collections.emptyList());
