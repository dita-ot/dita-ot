...
public final class FilterUtils {
  ...
  private Set<Flag> checkConflict(Set<Flag> res) {
    ...
    if ((conflictColor && foregroundConflictColor != null) || (conflictBackcolor && backgroundConflictColor != null)) {
      return res
        .stream()
        .map(f ->
          new Flag(
  ...
  public record Flag(
    ...
    public void writeEndFlag(final ContentHandler contentHandler) throws SAXException {
      contentHandler.startElement(
        ...
        DITA_OT_D_DITAVAL_ENDPROP.localName,
        new XMLUtils.AttributesBuilder().add(ATTRIBUTE_NAME_CLASS, DITA_OT_D_DITAVAL_ENDPROP.toString()).build()
      );
