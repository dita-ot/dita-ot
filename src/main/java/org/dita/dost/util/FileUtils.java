...
public final class FileUtils {
  ...
  @Deprecated public static final List<String> supportedImageExtensions;
  ...
  @Deprecated private static final List<String> supportedHTMLExtensions;
  ...
  @Deprecated private static final List<String> supportedResourceExtensions;
  ...
  private static String getRelativePath(
      final String basePath, final String refPath, final String sep) {
  ...
  /**
   * Normalize topic path base on current directory and href value, by replacing "\\" and "\" with
   * {@link File#separator}, and removing ".", ".." from the file path, with no change to substring
   * behind "#".
   *
  ...
  public static String resolveTopic(final File rootPath, final String relativePath) {
    return setFragment(
        resolve(rootPath, stripFragment(relativePath)).getPath(), getFragment(relativePath));
  }
  ...
  public static URI resolve(final File rootPath, final URI relativePath) {
    return URLUtils.toURI(
        resolve(rootPath != null ? rootPath.getPath() : null, relativePath.getPath()));
  }

  /**
   * Resolve file path against a base directory path. Normalize the input file path, by replacing
   * all the '\\', '/' with File.seperator, and removing '..' from the directory.
   *
   * <p>Note: the substring behind "#" will be removed.
   *
