...
public final class Constants {
  ...
  public static final DitaClass BOOKMAP_ABBREVLIST =
      DitaClass.getInstance("- map/topicref bookmap/abbrevlist ");
  public static final DitaClass BOOKMAP_AMENDMENTS =
      DitaClass.getInstance("- map/topicref bookmap/amendments ");
  public static final DitaClass BOOKMAP_APPENDICES =
      DitaClass.getInstance("- map/topicref bookmap/appendices ");
  public static final DitaClass BOOKMAP_APPENDIX =
      DitaClass.getInstance("- map/topicref bookmap/appendix ");
  public static final DitaClass BOOKMAP_APPROVED =
      DitaClass.getInstance("- topic/data bookmap/approved ");
  public static final DitaClass BOOKMAP_BACKMATTER =
      DitaClass.getInstance("- map/topicref bookmap/backmatter ");
  public static final DitaClass BOOKMAP_BIBLIOLIST =
      DitaClass.getInstance("- map/topicref bookmap/bibliolist ");
  public static final DitaClass BOOKMAP_BOOKABSTRACT =
      DitaClass.getInstance("- map/topicref bookmap/bookabstract ");
  public static final DitaClass BOOKMAP_BOOKCHANGEHISTORY =
      DitaClass.getInstance("- topic/data bookmap/bookchangehistory ");
  public static final DitaClass BOOKMAP_BOOKEVENT =
      DitaClass.getInstance("- topic/data bookmap/bookevent ");
  public static final DitaClass BOOKMAP_BOOKEVENTTYPE =
      DitaClass.getInstance("- topic/data bookmap/bookeventtype ");
  public static final DitaClass BOOKMAP_BOOKID =
      DitaClass.getInstance("- topic/data bookmap/bookid ");
  public static final DitaClass BOOKMAP_BOOKLIBRARY =
      DitaClass.getInstance("- topic/ph bookmap/booklibrary ");
  public static final DitaClass BOOKMAP_BOOKLIST =
      DitaClass.getInstance("- map/topicref bookmap/booklist ");
  public static final DitaClass BOOKMAP_BOOKLISTS =
      DitaClass.getInstance("- map/topicref bookmap/booklists ");
  public static final DitaClass BOOKMAP_BOOKMAP =
      DitaClass.getInstance("- map/map bookmap/bookmap ");
  public static final DitaClass BOOKMAP_BOOKMETA =
      DitaClass.getInstance("- map/topicmeta bookmap/bookmeta ");
  public static final DitaClass BOOKMAP_BOOKNUMBER =
      DitaClass.getInstance("- topic/data bookmap/booknumber ");
  public static final DitaClass BOOKMAP_BOOKOWNER =
      DitaClass.getInstance("- topic/data bookmap/bookowner ");
  public static final DitaClass BOOKMAP_BOOKPARTNO =
      DitaClass.getInstance("- topic/data bookmap/bookpartno ");
  public static final DitaClass BOOKMAP_BOOKRESTRICTION =
      DitaClass.getInstance("- topic/data bookmap/bookrestriction ");
  public static final DitaClass BOOKMAP_BOOKRIGHTS =
      DitaClass.getInstance("- topic/data bookmap/bookrights ");
  public static final DitaClass BOOKMAP_BOOKTITLE =
      DitaClass.getInstance("- topic/title bookmap/booktitle ");
  public static final DitaClass BOOKMAP_BOOKTITLEALT =
      DitaClass.getInstance("- topic/ph bookmap/booktitlealt ");
  public static final DitaClass BOOKMAP_CHAPTER =
      DitaClass.getInstance("- map/topicref bookmap/chapter ");
  public static final DitaClass BOOKMAP_COLOPHON =
      DitaClass.getInstance("- map/topicref bookmap/colophon ");
  public static final DitaClass BOOKMAP_COMPLETED =
      DitaClass.getInstance("- topic/ph bookmap/completed ");
  public static final DitaClass BOOKMAP_COPYRFIRST =
      DitaClass.getInstance("- topic/data bookmap/copyrfirst ");
  public static final DitaClass BOOKMAP_COPYRLAST =
      DitaClass.getInstance("- topic/data bookmap/copyrlast ");
  public static final DitaClass BOOKMAP_DAY = DitaClass.getInstance("- topic/ph bookmap/day ");
  public static final DitaClass BOOKMAP_DEDICATION =
      DitaClass.getInstance("- map/topicref bookmap/dedication ");
  public static final DitaClass BOOKMAP_DRAFTINTRO =
      DitaClass.getInstance("- map/topicref bookmap/draftintro ");
  public static final DitaClass BOOKMAP_EDITED =
      DitaClass.getInstance("- topic/data bookmap/edited ");
  public static final DitaClass BOOKMAP_EDITION =
      DitaClass.getInstance("- topic/data bookmap/edition ");
  public static final DitaClass BOOKMAP_FIGURELIST =
      DitaClass.getInstance("- map/topicref bookmap/figurelist ");
  public static final DitaClass BOOKMAP_FRONTMATTER =
      DitaClass.getInstance("- map/topicref bookmap/frontmatter ");
  public static final DitaClass BOOKMAP_GLOSSARYLIST =
      DitaClass.getInstance("- map/topicref bookmap/glossarylist ");
  public static final DitaClass BOOKMAP_INDEXLIST =
      DitaClass.getInstance("- map/topicref bookmap/indexlist ");
  public static final DitaClass BOOKMAP_ISBN = DitaClass.getInstance("- topic/data bookmap/isbn ");
  public static final DitaClass BOOKMAP_MAINBOOKTITLE =
      DitaClass.getInstance("- topic/ph bookmap/mainbooktitle ");
  public static final DitaClass BOOKMAP_MAINTAINER =
      DitaClass.getInstance("- topic/data bookmap/maintainer ");
  public static final DitaClass BOOKMAP_MONTH = DitaClass.getInstance("- topic/ph bookmap/month ");
  public static final DitaClass BOOKMAP_NOTICES =
      DitaClass.getInstance("- map/topicref bookmap/notices ");
  public static final DitaClass BOOKMAP_ORGANIZATION =
      DitaClass.getInstance("- topic/data bookmap/organization ");
  public static final DitaClass BOOKMAP_PART =
      DitaClass.getInstance("- map/topicref bookmap/part ");
  public static final DitaClass BOOKMAP_PERSON =
      DitaClass.getInstance("- topic/data bookmap/person ");
  public static final DitaClass BOOKMAP_PREFACE =
      DitaClass.getInstance("- map/topicref bookmap/preface ");
  public static final DitaClass BOOKMAP_PRINTLOCATION =
      DitaClass.getInstance("- topic/data bookmap/printlocation ");
  public static final DitaClass BOOKMAP_PUBLISHED =
      DitaClass.getInstance("- topic/data bookmap/published ");
  ...
  public static final DitaClass BOOKMAP_PUBLISHTYPE =
      DitaClass.getInstance("- topic/data bookmap/publishtype ");
  public static final DitaClass BOOKMAP_REVIEWED =
      DitaClass.getInstance("- topic/data bookmap/reviewed ");
  public static final DitaClass BOOKMAP_REVISIONID =
      DitaClass.getInstance("- topic/ph bookmap/revisionid ");
  public static final DitaClass BOOKMAP_STARTED =
      DitaClass.getInstance("- topic/ph bookmap/started ");
  public static final DitaClass BOOKMAP_SUMMARY =
      DitaClass.getInstance("- topic/ph bookmap/summary ");
  public static final DitaClass BOOKMAP_TABLELIST =
      DitaClass.getInstance("- map/topicref bookmap/tablelist ");
  public static final DitaClass BOOKMAP_TESTED =
      DitaClass.getInstance("- topic/data bookmap/tested ");
  ...
  public static final DitaClass BOOKMAP_VOLUME =
      DitaClass.getInstance("- topic/data bookmap/volume ");
  ...
  public static final DitaClass CLASSIFY_D_TOPICCELL =
      DitaClass.getInstance("+ map/relcell classify-d/topicCell ");
  ...
  public static final DitaClass CONCEPT_CONBODY =
      DitaClass.getInstance("- topic/body concept/conbody ");
  public static final DitaClass CONCEPT_CONBODYDIV =
      DitaClass.getInstance("- topic/bodydiv concept/conbodydiv ");
  public static final DitaClass CONCEPT_CONCEPT =
      DitaClass.getInstance("- topic/topic concept/concept ");
  ...
  public static final DitaClass GLOSSREF_D_GLOSSREF =
      DitaClass.getInstance("+ map/topicref glossref-d/glossref ");
  public static final DitaClass HAZARD_D_CONSEQUENCE =
      DitaClass.getInstance("+ topic/li hazard-d/consequence ");
  public static final DitaClass HAZARD_D_HAZARDSTATEMENT =
      DitaClass.getInstance("+ topic/note hazard-d/hazardstatement ");
  public static final DitaClass HAZARD_D_HAZARDSYMBOL =
      DitaClass.getInstance("+ topic/image hazard-d/hazardsymbol ");
  public static final DitaClass HAZARD_D_HOWTOAVOID =
      DitaClass.getInstance("+ topic/li hazard-d/howtoavoid ");
  public static final DitaClass HAZARD_D_MESSAGEPANEL =
      DitaClass.getInstance("+ topic/ul hazard-d/messagepanel ");
  public static final DitaClass HAZARD_D_TYPEOFHAZARD =
      DitaClass.getInstance("+ topic/li hazard-d/typeofhazard ");
  ...
  public static final DitaClass HI_D_LINE_THROUGH =
  ...
  public static final DitaClass LEARNING_D_LCMATCHINGITEMFEEDBACK =
      DitaClass.getInstance(
  ...
  public static final DitaClass LEARNING_D_LCMULTIPLESELECT =
      DitaClass.getInstance(
  ...
  public static final DitaClass LEARNING2_D_LCMATCHINGITEMFEEDBACK2 =
      DitaClass.getInstance(
  ...
  public static final DitaClass LEARNING2_D_LCMATCHTABLE2 =
      DitaClass.getInstance(
          "+ topic/simpletable learningInteractionBase2-d/simpletable learning2-d/lcMatchTable2 ");
  public static final DitaClass LEARNING2_D_LCMULTIPLESELECT2 =
      DitaClass.getInstance(
  ...
  public static final DitaClass LEARNING2_D_LCOPENQUESTION2 =
      DitaClass.getInstance(
  ...
  public static final DitaClass LEARNING2_D_LCSEQUENCING2 =
      DitaClass.getInstance(
          "+ topic/div learningInteractionBase2-d/lcInteractionBase2 learning2-d/lcSequencing2 ");
  public static final DitaClass LEARNING2_D_LCSINGLESELECT2 =
      DitaClass.getInstance(
          "+ topic/div learningInteractionBase2-d/lcInteractionBase2 learning2-d/lcSingleSelect2 ");
  public static final DitaClass LEARNING2_D_LCTRUEFALSE2 =
      DitaClass.getInstance(
  ...
  public static final DitaClass LEARNINGASSESSMENT_LEARNINGASSESSMENTBODY =
      DitaClass.getInstance(
  ...
  public static final DitaClass LEARNINGBASE_LCINTRO =
      DitaClass.getInstance("- topic/section learningBase/lcIntro ");
  ...
  public static final DitaClass LEARNINGBASE_LCTIME =
  ...
  public static final DitaClass MAPGROUP_D_ANCHORREF =
      DitaClass.getInstance("+ map/topicref mapgroup-d/anchorref ");
  public static final DitaClass MAPGROUP_D_KEYDEF =
      DitaClass.getInstance("+ map/topicref mapgroup-d/keydef ");
  public static final DitaClass MAPGROUP_D_MAPREF =
      DitaClass.getInstance("+ map/topicref mapgroup-d/mapref ");
  public static final DitaClass MAPGROUP_D_TOPICGROUP =
      DitaClass.getInstance("+ map/topicref mapgroup-d/topicgroup ");
  public static final DitaClass MAPGROUP_D_TOPICHEAD =
      DitaClass.getInstance("+ map/topicref mapgroup-d/topichead ");
  public static final DitaClass MAPGROUP_D_TOPICSET =
      DitaClass.getInstance("+ map/topicref mapgroup-d/topicset ");
  public static final DitaClass MAPGROUP_D_TOPICSETREF =
      DitaClass.getInstance("+ map/topicref mapgroup-d/topicsetref ");
  public static final DitaClass MARKUP_D_MARKUPNAME =
      DitaClass.getInstance("+ topic/keyword markup-d/markupname ");
  public static final DitaClass MATHML_D_MATHML =
      DitaClass.getInstance("+ topic/foreign mathml-d/mathml ");
  public static final DitaClass MATHML_D_MATHMLREF =
      DitaClass.getInstance("+ topic/xref mathml-d/mathmlref ");
  public static final DitaClass PR_D_APINAME =
      DitaClass.getInstance("+ topic/keyword pr-d/apiname ");
  public static final DitaClass PR_D_CODEBLOCK =
      DitaClass.getInstance("+ topic/pre pr-d/codeblock ");
  ...
  public static final DitaClass PR_D_FRAGMENT =
      DitaClass.getInstance("+ topic/figgroup pr-d/fragment ");
  public static final DitaClass PR_D_FRAGREF = DitaClass.getInstance("+ topic/xref pr-d/fragref ");
  public static final DitaClass PR_D_GROUPCHOICE =
      DitaClass.getInstance("+ topic/figgroup pr-d/groupchoice ");
  public static final DitaClass PR_D_GROUPCOMP =
      DitaClass.getInstance("+ topic/figgroup pr-d/groupcomp ");
  public static final DitaClass PR_D_GROUPSEQ =
      DitaClass.getInstance("+ topic/figgroup pr-d/groupseq ");
  ...
  public static final DitaClass PR_D_PARMNAME =
  ...
  public static final DitaClass PR_D_PLENTRY =
      DitaClass.getInstance("+ topic/dlentry pr-d/plentry ");
  ...
  public static final DitaClass PR_D_SYNBLK =
      DitaClass.getInstance("+ topic/figgroup pr-d/synblk ");
  public static final DitaClass PR_D_SYNNOTE = DitaClass.getInstance("+ topic/fn pr-d/synnote ");
  public static final DitaClass PR_D_SYNNOTEREF =
  ...
  public static final DitaClass PR_D_SYNTAXDIAGRAM =
      DitaClass.getInstance("+ topic/fig pr-d/syntaxdiagram ");
  public static final DitaClass PR_D_VAR = DitaClass.getInstance("+ topic/ph pr-d/var ");
  public static final DitaClass REFERENCE_PROPDESC =
      DitaClass.getInstance("- topic/stentry reference/propdesc ");
  public static final DitaClass REFERENCE_PROPDESCHD =
      DitaClass.getInstance("- topic/stentry reference/propdeschd ");
  public static final DitaClass REFERENCE_PROPERTIES =
      DitaClass.getInstance("- topic/simpletable reference/properties ");
  public static final DitaClass REFERENCE_PROPERTY =
      DitaClass.getInstance("- topic/strow reference/property ");
  public static final DitaClass REFERENCE_PROPHEAD =
      DitaClass.getInstance("- topic/sthead reference/prophead ");
  public static final DitaClass REFERENCE_PROPTYPE =
      DitaClass.getInstance("- topic/stentry reference/proptype ");
  public static final DitaClass REFERENCE_PROPTYPEHD =
      DitaClass.getInstance("- topic/stentry reference/proptypehd ");
  public static final DitaClass REFERENCE_PROPVALUE =
      DitaClass.getInstance("- topic/stentry reference/propvalue ");
  public static final DitaClass REFERENCE_PROPVALUEHD =
      DitaClass.getInstance("- topic/stentry reference/propvaluehd ");
  public static final DitaClass REFERENCE_REFBODY =
      DitaClass.getInstance("- topic/body reference/refbody ");
  public static final DitaClass REFERENCE_REFBODYDIV =
      DitaClass.getInstance("- topic/bodydiv reference/refbodydiv ");
  public static final DitaClass REFERENCE_REFERENCE =
      DitaClass.getInstance("- topic/topic reference/reference ");
  public static final DitaClass REFERENCE_REFSYN =
      DitaClass.getInstance("- topic/section reference/refsyn ");
  ...
  public static final DitaClass RELMGMT_D_CHANGE_ITEM =
      DitaClass.getInstance("+ topic/data relmgmt-d/change-item ");
  ...
  public static final DitaClass SVG_D_SVG_CONTAINER =
      DitaClass.getInstance("+ topic/foreign svg-d/svg-container ");
  public static final DitaClass SVG_D_SVGREF = DitaClass.getInstance("+ topic/xref svg-d/svgref ");
  public static final DitaClass SW_D_CMDNAME =
  ...
  public static final DitaClass SW_D_SYSTEMOUTPUT =
      DitaClass.getInstance("+ topic/ph sw-d/systemoutput ");
  public static final DitaClass SW_D_USERINPUT =
      DitaClass.getInstance("+ topic/ph sw-d/userinput ");
  public static final DitaClass SW_D_VARNAME =
      DitaClass.getInstance("+ topic/keyword sw-d/varname ");
  public static final DitaClass SYNTAX_D_DELIM =
      DitaClass.getInstance("+ topic/ph syntaxdiagram-d/delim ");
  public static final DitaClass SYNTAX_D_FRAGMENT =
      DitaClass.getInstance("+ topic/figgroup syntaxdiagram-d/fragment ");
  public static final DitaClass SYNTAX_D_FRAGREF =
      DitaClass.getInstance("+ topic/xref syntaxdiagram-d/fragref ");
  ...
  public static final DitaClass SYNTAX_D_KWD =
      DitaClass.getInstance("+ topic/keyword syntaxdiagram-d/kwd ");
  public static final DitaClass SYNTAX_D_OPER =
      DitaClass.getInstance("+ topic/ph syntaxdiagram-d/oper ");
  public static final DitaClass SYNTAX_D_REPSEP =
      DitaClass.getInstance("+ topic/ph syntaxdiagram-d/repsep ");
  public static final DitaClass SYNTAX_D_SEP =
      DitaClass.getInstance("+ topic/ph syntaxdiagram-d/sep ");
  public static final DitaClass SYNTAX_D_SYNBLK =
      DitaClass.getInstance("+ topic/figgroup syntaxdiagram-d/synblk ");
  public static final DitaClass SYNTAX_D_SYNNOTE =
      DitaClass.getInstance("+ topic/fn syntaxdiagram-d/synnote ");
  public static final DitaClass SYNTAX_D_SYNNOTEREF =
      DitaClass.getInstance("+ topic/xref syntaxdiagram-d/synnoteref ");
  public static final DitaClass SYNTAX_D_SYNPH =
      DitaClass.getInstance("+ topic/ph syntaxdiagram-d/synph ");
  public static final DitaClass SYNTAX_D_SYNTAXDIAGRAM =
      DitaClass.getInstance("+ topic/fig syntaxdiagram-d/syntaxdiagram ");
  public static final DitaClass SYNTAX_D_VAR =
      DitaClass.getInstance("+ topic/ph syntaxdiagram-d/var ");
  public static final DitaClass TASK_CHDESC = DitaClass.getInstance("- topic/stentry task/chdesc ");
  public static final DitaClass TASK_CHDESCHD =
      DitaClass.getInstance("- topic/stentry task/chdeschd ");
  ...
  public static final DitaClass TASK_CHOICETABLE =
      DitaClass.getInstance("- topic/simpletable task/choicetable ");
  public static final DitaClass TASK_CHOPTION =
      DitaClass.getInstance("- topic/stentry task/choption ");
  public static final DitaClass TASK_CHOPTIONHD =
      DitaClass.getInstance("- topic/stentry task/choptionhd ");
  ...
  public static final DitaClass TASK_CONTEXT =
      DitaClass.getInstance("- topic/section task/context ");
  public static final DitaClass TASK_INFO = DitaClass.getInstance("- topic/itemgroup task/info ");
  public static final DitaClass TASK_POSTREQ =
      DitaClass.getInstance("- topic/section task/postreq ");
  ...
  public static final DitaClass TASK_STEPRESULT =
  ...
  public static final DitaClass TASK_STEPS_INFORMAL =
      DitaClass.getInstance("- topic/section task/steps-informal ");
  public static final DitaClass TASK_STEPS_UNORDERED =
      DitaClass.getInstance("- topic/ul task/steps-unordered ");
  public static final DitaClass TASK_STEPSECTION =
      DitaClass.getInstance("- topic/li task/stepsection ");
  public static final DitaClass TASK_STEPTROUBLESHOOTING =
      DitaClass.getInstance("- topic/itemgroup task/steptroubleshooting ");
  public static final DitaClass TASK_STEPXMP =
  ...
  public static final DitaClass TASK_TASKBODY =
      DitaClass.getInstance("- topic/body task/taskbody ");
  public static final DitaClass TASK_TASKTROUBLESHOOTING =
      DitaClass.getInstance("- topic/section task/tasktroubleshooting ");
  public static final DitaClass TASK_TUTORIALINFO =
  ...
  public static final DitaClass TASKREQ_D_ESTTIME =
      DitaClass.getInstance("+ topic/li task/li taskreq-d/esttime ");
  public static final DitaClass TASKREQ_D_NOCONDS =
      DitaClass.getInstance("+ topic/li task/li taskreq-d/noconds ");
  public static final DitaClass TASKREQ_D_NOSAFETY =
      DitaClass.getInstance("+ topic/li task/li taskreq-d/nosafety ");
  ...
  public static final DitaClass TASKREQ_D_PERSCAT =
      DitaClass.getInstance("+ topic/li task/li taskreq-d/perscat ");
  public static final DitaClass TASKREQ_D_PERSKILL =
      DitaClass.getInstance("+ topic/li task/li taskreq-d/perskill ");
  ...
  public static final DitaClass TASKREQ_D_REQCOND =
      DitaClass.getInstance("+ topic/li task/li taskreq-d/reqcond ");
  public static final DitaClass TASKREQ_D_REQCONDS =
      DitaClass.getInstance("+ topic/ul task/ul taskreq-d/reqconds ");
  public static final DitaClass TASKREQ_D_REQCONTP =
      DitaClass.getInstance("+ topic/li task/li taskreq-d/reqcontp ");
  public static final DitaClass TASKREQ_D_REQPERS =
      DitaClass.getInstance("+ topic/ul task/ul taskreq-d/reqpers ");
  public static final DitaClass TASKREQ_D_SAFECOND =
      DitaClass.getInstance("+ topic/li task/li taskreq-d/safecond ");
  public static final DitaClass TASKREQ_D_SAFETY =
      DitaClass.getInstance("+ topic/ol task/ol taskreq-d/safety ");
  public static final DitaClass TASKREQ_D_SPARE =
      DitaClass.getInstance("+ topic/li task/li taskreq-d/spare ");
  public static final DitaClass TASKREQ_D_SPARES =
      DitaClass.getInstance("+ topic/p task/p taskreq-d/spares ");
  public static final DitaClass TASKREQ_D_SPARESLI =
      DitaClass.getInstance("+ topic/ul task/ul taskreq-d/sparesli ");
  public static final DitaClass TASKREQ_D_SUPEQLI =
      DitaClass.getInstance("+ topic/ul task/ul taskreq-d/supeqli ");
  public static final DitaClass TASKREQ_D_SUPEQUI =
      DitaClass.getInstance("+ topic/li task/li taskreq-d/supequi ");
  public static final DitaClass TASKREQ_D_SUPEQUIP =
      DitaClass.getInstance("+ topic/p task/p taskreq-d/supequip ");
  public static final DitaClass TASKREQ_D_SUPPLIES =
      DitaClass.getInstance("+ topic/p task/p taskreq-d/supplies ");
  public static final DitaClass TASKREQ_D_SUPPLY =
      DitaClass.getInstance("+ topic/li task/li taskreq-d/supply ");
  public static final DitaClass TASKREQ_D_SUPPLYLI =
      DitaClass.getInstance("+ topic/ul task/ul taskreq-d/supplyli ");
  ...
  public static final DitaClass TOPIC_DRAFT_COMMENT =
      DitaClass.getInstance("- topic/draft-comment ");
  ...
  public static final DitaClass TOPIC_NO_TOPIC_NESTING =
      DitaClass.getInstance("- topic/no-topic-nesting ");
  ...
  public static final DitaClass TOPIC_RELATED_LINKS =
      DitaClass.getInstance("- topic/related-links ");
  public static final DitaClass TOPIC_REQUIRED_CLEANUP =
      DitaClass.getInstance("- topic/required-cleanup ");
  ...
  public static final DitaClass UI_D_MENUCASCADE =
  ...
  public static final DitaClass UI_D_SHORTCUT =
      DitaClass.getInstance("+ topic/keyword ui-d/shortcut ");
  public static final DitaClass UI_D_UICONTROL =
      DitaClass.getInstance("+ topic/ph ui-d/uicontrol ");
  public static final DitaClass UI_D_WINTITLE =
  ...
  public static final DitaClass XNAL_D_ADDRESSDETAILS =
      DitaClass.getInstance("+ topic/ph xnal-d/addressdetails ");
  ...
  public static final DitaClass XNAL_D_CONTACTNUMBER =
      DitaClass.getInstance("+ topic/data xnal-d/contactnumber ");
  public static final DitaClass XNAL_D_CONTACTNUMBERS =
      DitaClass.getInstance("+ topic/data xnal-d/contactnumbers ");
  public static final DitaClass XNAL_D_COUNTRY =
      DitaClass.getInstance("+ topic/ph xnal-d/country ");
  public static final DitaClass XNAL_D_EMAILADDRESS =
      DitaClass.getInstance("+ topic/data xnal-d/emailaddress ");
  public static final DitaClass XNAL_D_EMAILADDRESSES =
      DitaClass.getInstance("+ topic/data xnal-d/emailaddresses ");
  public static final DitaClass XNAL_D_FIRSTNAME =
      DitaClass.getInstance("+ topic/data xnal-d/firstname ");
  public static final DitaClass XNAL_D_GENERATIONIDENTIFIER =
      DitaClass.getInstance("+ topic/data xnal-d/generationidentifier ");
  public static final DitaClass XNAL_D_HONORIFIC =
      DitaClass.getInstance("+ topic/data xnal-d/honorific ");
  public static final DitaClass XNAL_D_LASTNAME =
      DitaClass.getInstance("+ topic/data xnal-d/lastname ");
  public static final DitaClass XNAL_D_LOCALITY =
      DitaClass.getInstance("+ topic/ph xnal-d/locality ");
  public static final DitaClass XNAL_D_LOCALITYNAME =
      DitaClass.getInstance("+ topic/ph xnal-d/localityname ");
  public static final DitaClass XNAL_D_MIDDLENAME =
      DitaClass.getInstance("+ topic/data xnal-d/middlename ");
  public static final DitaClass XNAL_D_NAMEDETAILS =
      DitaClass.getInstance("+ topic/data xnal-d/namedetails ");
  ...
  public static final DitaClass XNAL_D_OTHERINFO =
      DitaClass.getInstance("+ topic/data xnal-d/otherinfo ");
  public static final DitaClass XNAL_D_PERSONINFO =
      DitaClass.getInstance("+ topic/data xnal-d/personinfo ");
  public static final DitaClass XNAL_D_PERSONNAME =
      DitaClass.getInstance("+ topic/data xnal-d/personname ");
  public static final DitaClass XNAL_D_POSTALCODE =
      DitaClass.getInstance("+ topic/ph xnal-d/postalcode ");
  public static final DitaClass XNAL_D_THOROUGHFARE =
      DitaClass.getInstance("+ topic/ph xnal-d/thoroughfare ");
  ...
  @Deprecated public static final String INDEX_TYPE_HTMLHELP = "htmlhelp";
  ...
  @Deprecated public static final String TRANS_TYPE_PDF = "pdf";
  /** Constants for transform type(xhtml). Deprecated since 3.0 */
  @Deprecated public static final String TRANS_TYPE_XHTML = "xhtml";
  /** Constants for transform type(eclipsehelp). Deprecated since 3.0 */
  @Deprecated public static final String TRANS_TYPE_ECLIPSEHELP = "eclipsehelp";
  /** Constants for transform type(htmlhelp). Deprecated since 3.0 */
  @Deprecated public static final String TRANS_TYPE_HTMLHELP = "htmlhelp";
  /** Constants for transform type(eclipsecontent). Deprecated since 3.0 */
  @Deprecated public static final String TRANS_TYPE_ECLIPSECONTENT = "eclipsecontent";
  ...
  @Deprecated public static final String INPUT_DITAMAP = "user.input.file";

  public static final String INPUT_DITAMAP_URI = "user.input.file.uri";
  /**
   * Property name for input file list file list file, i.e. file which points to a file which points
   * to the input file
   */
  ...
  @Deprecated public static final String INPUT_DIR = "user.input.dir";
  ...
  public static final String ANT_INVOKER_EXT_PARAM_GENERATE_DEBUG_ATTR =
  ...
  @Deprecated public static final String STRING_EMPTY = "";
  /** LEFT_BRACKET. */
  ...
  @Deprecated public static final String BACK_SLASH = "\\";
  /** SHARP. */
  ...
  @Deprecated public static final String DOUBLE_BACK_SLASH = "\\\\";
  /** COLON_DOUBLE_SLASH. */
  ...
  public static final String SAX_DRIVER_SUN_HACK_CLASS =
  ...
  public static final String FEATURE_NAMESPACE_PREFIX =
  ...
  public static final String FEATURE_VALIDATION_SCHEMA =
      "http://apache.org/xml/features/validation/schema";
  /** TEMP_DIR_DEFAULT. Deprecated since 3.0 */
  @Deprecated public static final String TEMP_DIR_DEFAULT = "temp";
  /** FILTER_ACTION_EXCLUDE. Deprecated since 3.0 */
  @Deprecated public static final String FILTER_ACTION_EXCLUDE = "exclude";
  ...
  public static final String ATTRIBUTE_NAME_NONAMESPACESCHEMALOCATION =
      XSI_NS_PREFIX + ":noNamespaceSchemaLocation";
  /** dita-ot:orig-href. */
  public static final String ATTRIBUTE_NAME_DITA_OT_ORIG_HREF =
      DITA_OT_NS_PREFIX + ":" + "orig-href";

  /** ATTR_CLASS_VALUE_SUBJECT_SCHEME_BASE. Deprecated since 3.0 */
  @Deprecated public static final String ATTR_CLASS_VALUE_SUBJECT_SCHEME_BASE = " subjectScheme/";
   ...
   */
  @Deprecated public static final String IndexTerm_Prefix_See = "See";
  /**
   * constants for indexterm prefix(See also).
   *
   * @deprecated since 3.2
   */
  @Deprecated public static final String IndexTerm_Prefix_See_Also = "See also";
  /** name attribute. */
  public static final String ATTRIBUTE_NAME_NAME = "name";
  /** type attribute value subjectScheme. */
  public static final String ATTR_TYPE_VALUE_SUBJECT_SCHEME = "subjectScheme";
  /**
   * store how many scheme files a ditamap file used in form of {@code Map&lt;String,
   * Set&lt;String>>}.
   */
  ...
  public static final String OASIS_CATALOG_NAMESPACE =
      "urn:oasis:names:tc:entity:xmlns:xml:catalog";

  /** Deprecated since 2.3 */
  @Deprecated public static final String PI_PATH2PROJ_TARGET = "path2project";
  ...
  /** Deprecated since 2.3 */
  @Deprecated public static final String PI_WORKDIR_TARGET = "workdir";
