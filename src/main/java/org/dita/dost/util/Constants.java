...
public final class Constants {
  ...
  public static final DitaClass ABBREV_D_ABBREVIATED_FORM = DitaClass.getInstance(
  ...
  public static final DitaClass BOOKMAP_BOOKCHANGEHISTORY = DitaClass.getInstance(
  ...
  public static final DitaClass BOOKMAP_BOOKRESTRICTION = DitaClass.getInstance(
  ...
  public static final DitaClass BOOKMAP_PUBLISHERINFORMATION = DitaClass.getInstance(
  ...
  public static final DitaClass CLASSIFY_D_TOPICSUBJECT = DitaClass.getInstance(
    "+ map/topicref classify-d/topicsubject "
  );
  public static final DitaClass CLASSIFY_D_TOPICSUBJECTHEADER = DitaClass.getInstance(
    "+ map/relrow classify-d/topicSubjectHeader "
  );
  public static final DitaClass CLASSIFY_D_TOPICSUBJECTROW = DitaClass.getInstance(
    "+ map/relrow classify-d/topicSubjectRow "
  );
  public static final DitaClass CLASSIFY_D_TOPICSUBJECTTABLE = DitaClass.getInstance(
  ...
  public static final DitaClass DITAVAREF_D_DITAVALMETA = DitaClass.getInstance(
    "+ map/topicmeta ditavalref-d/ditavalmeta "
  );
  public static final DitaClass DITAVAREF_D_DITAVALREF = DitaClass.getInstance(
    "+ map/topicref ditavalref-d/ditavalref "
  );
  public static final DitaClass DITAVAREF_D_DVR_KEYSCOPEPREFIX = DitaClass.getInstance(
    "+ topic/data ditavalref-d/dvrKeyscopePrefix "
  );
  public static final DitaClass DITAVAREF_D_DVR_KEYSCOPESUFFIX = DitaClass.getInstance(
    "+ topic/data ditavalref-d/dvrKeyscopeSuffix "
  );
  public static final DitaClass DITAVAREF_D_DVR_RESOURCEPREFIX = DitaClass.getInstance(
    "+ topic/data ditavalref-d/dvrResourcePrefix "
  );
  public static final DitaClass DITAVAREF_D_DVR_RESOURCESUFFIX = DitaClass.getInstance(
    "+ topic/data ditavalref-d/dvrResourceSuffix "
  );
  public static final DitaClass EQUATION_D_EQUATION_BLOCK = DitaClass.getInstance(
    "+ topic/div equation-d/equation-block "
  );
  public static final DitaClass EQUATION_D_EQUATION_FIGURE = DitaClass.getInstance(
    "+ topic/fig equation-d/equation-figure "
  );
  public static final DitaClass EQUATION_D_EQUATION_INLINE = DitaClass.getInstance(
    "+ topic/ph equation-d/equation-inline "
  );
  public static final DitaClass EQUATION_D_EQUATION_NUMBER = DitaClass.getInstance(
    "+ topic/ph equation-d/equation-number "
  );
  public static final DitaClass GLOSSENTRY_GLOSSABBREVIATION = DitaClass.getInstance(
    "- topic/title concept/title glossentry/glossAbbreviation "
  );
  public static final DitaClass GLOSSENTRY_GLOSSACRONYM = DitaClass.getInstance(
    "- topic/title concept/title glossentry/glossAcronym "
  );
  public static final DitaClass GLOSSENTRY_GLOSSALT = DitaClass.getInstance(
    "- topic/section concept/section glossentry/glossAlt "
  );
  public static final DitaClass GLOSSENTRY_GLOSSALTERNATEFOR = DitaClass.getInstance(
    "- topic/xref concept/xref glossentry/glossAlternateFor "
  );
  public static final DitaClass GLOSSENTRY_GLOSSBODY = DitaClass.getInstance(
    "- topic/body concept/conbody glossentry/glossBody "
  );
  public static final DitaClass GLOSSENTRY_GLOSSDEF = DitaClass.getInstance(
    "- topic/abstract concept/abstract glossentry/glossdef "
  );
  public static final DitaClass GLOSSENTRY_GLOSSENTRY = DitaClass.getInstance(
    "- topic/topic concept/concept glossentry/glossentry "
  );
  public static final DitaClass GLOSSENTRY_GLOSSPARTOFSPEECH = DitaClass.getInstance(
    "- topic/data concept/data glossentry/glossPartOfSpeech "
  );
  public static final DitaClass GLOSSENTRY_GLOSSPROPERTY = DitaClass.getInstance(
    "- topic/data concept/data glossentry/glossProperty "
  );
  public static final DitaClass GLOSSENTRY_GLOSSSCOPENOTE = DitaClass.getInstance(
    "- topic/note concept/note glossentry/glossScopeNote "
  );
  public static final DitaClass GLOSSENTRY_GLOSSSHORTFORM = DitaClass.getInstance(
    "- topic/title concept/title glossentry/glossShortForm "
  );
  public static final DitaClass GLOSSENTRY_GLOSSSTATUS = DitaClass.getInstance(
    "- topic/data concept/data glossentry/glossStatus "
  );
  public static final DitaClass GLOSSENTRY_GLOSSSURFACEFORM = DitaClass.getInstance(
    "- topic/p concept/p glossentry/glossSurfaceForm "
  );
  public static final DitaClass GLOSSENTRY_GLOSSSYMBOL = DitaClass.getInstance(
    "- topic/image concept/image glossentry/glossSymbol "
  );
  public static final DitaClass GLOSSENTRY_GLOSSSYNONYM = DitaClass.getInstance(
    "- topic/title concept/title glossentry/glossSynonym "
  );
  public static final DitaClass GLOSSENTRY_GLOSSTERM = DitaClass.getInstance(
    "- topic/title concept/title glossentry/glossterm "
  );
  public static final DitaClass GLOSSENTRY_GLOSSUSAGE = DitaClass.getInstance(
    "- topic/note concept/note glossentry/glossUsage "
  );
  public static final DitaClass GLOSSGROUP_GLOSSGROUP = DitaClass.getInstance(
  ...
  public static final DitaClass HAZARD_D_HAZARDSTATEMENT = DitaClass.getInstance(
  ...
  public static final DitaClass INDEXING_D_INDEX_SEE = DitaClass.getInstance(
    "+ topic/index-base indexing-d/index-see "
  );
  public static final DitaClass INDEXING_D_INDEX_SEE_ALSO = DitaClass.getInstance(
    "+ topic/index-base indexing-d/index-see-also "
  );
  public static final DitaClass INDEXING_D_INDEX_SORT_AS = DitaClass.getInstance(
    "+ topic/index-base indexing-d/index-sort-as "
  );
  public static final DitaClass LEARNING_D_LCANSWERCONTENT = DitaClass.getInstance(
    "+ topic/p learningInteractionBase-d/p learning-d/lcAnswerContent "
  );
  public static final DitaClass LEARNING_D_LCANSWEROPTION = DitaClass.getInstance(
    "+ topic/li learningInteractionBase-d/li learning-d/lcAnswerOption "
  );
  public static final DitaClass LEARNING_D_LCANSWEROPTIONGROUP = DitaClass.getInstance(
    "+ topic/ul learningInteractionBase-d/ul learning-d/lcAnswerOptionGroup "
  );
  public static final DitaClass LEARNING_D_LCAREA = DitaClass.getInstance(
    "+ topic/figgroup learningInteractionBase-d/figgroup learning-d/lcArea "
  );
  public static final DitaClass LEARNING_D_LCAREACOORDS = DitaClass.getInstance(
    "+ topic/ph learningInteractionBase-d/ph learning-d/lcAreaCoords "
  );
  public static final DitaClass LEARNING_D_LCAREASHAPE = DitaClass.getInstance(
    "+ topic/keyword learningInteractionBase-d/keyword learning-d/lcAreaShape "
  );
  public static final DitaClass LEARNING_D_LCASSET = DitaClass.getInstance(
    "+ topic/p learningInteractionBase-d/p learning-d/lcAsset "
  );
  public static final DitaClass LEARNING_D_LCCORRECTRESPONSE = DitaClass.getInstance(
    "+ topic/data learningInteractionBase-d/data learning-d/lcCorrectResponse "
  );
  public static final DitaClass LEARNING_D_LCFEEDBACK = DitaClass.getInstance(
    "+ topic/p learningInteractionBase-d/p learning-d/lcFeedback "
  );
  public static final DitaClass LEARNING_D_LCFEEDBACKCORRECT = DitaClass.getInstance(
    "+ topic/p learningInteractionBase-d/p learning-d/lcFeedbackCorrect "
  );
  public static final DitaClass LEARNING_D_LCFEEDBACKINCORRECT = DitaClass.getInstance(
    "+ topic/p learningInteractionBase-d/p learning-d/lcFeedbackIncorrect "
  );
  public static final DitaClass LEARNING_D_LCHOTSPOT = DitaClass.getInstance(
    "+ topic/fig learningInteractionBase-d/lcInteractionBase learning-d/lcHotspot "
  );
  public static final DitaClass LEARNING_D_LCHOTSPOTMAP = DitaClass.getInstance(
    "+ topic/fig learningInteractionBase-d/figgroup learning-d/lcHotspotMap "
  );
  public static final DitaClass LEARNING_D_LCINSTRUCTORNOTE = DitaClass.getInstance(
    "+ topic/note learningInteractionBase-d/note learning-d/lcInstructornote "
  );
  public static final DitaClass LEARNING_D_LCITEM = DitaClass.getInstance(
    "+ topic/stentry learningInteractionBase-d/stentry learning-d/lcItem "
  );
  public static final DitaClass LEARNING_D_LCMATCHING = DitaClass.getInstance(
    "+ topic/fig learningInteractionBase-d/lcInteractionBase learning-d/lcMatching "
  );
  public static final DitaClass LEARNING_D_LCMATCHINGHEADER = DitaClass.getInstance(
    "+ topic/sthead learningInteractionBase-d/sthead learning-d/lcMatchingHeader "
  );
  public static final DitaClass LEARNING_D_LCMATCHINGITEM = DitaClass.getInstance(
  ...
  public static final DitaClass LEARNING_D_LCMATCHINGPAIR = DitaClass.getInstance(
    "+ topic/strow learningInteractionBase-d/strow learning-d/lcMatchingPair "
  );
  public static final DitaClass LEARNING_D_LCMATCHTABLE = DitaClass.getInstance(
  ...
  public static final DitaClass LEARNING_D_LCOPENANSWER = DitaClass.getInstance(
    "+ topic/p learningInteractionBase-d/p learning-d/lcOpenAnswer "
  );
  public static final DitaClass LEARNING_D_LCOPENQUESTION = DitaClass.getInstance(
    "+ topic/fig learningInteractionBase-d/lcInteractionBase learning-d/lcOpenQuestion "
  );
  public static final DitaClass LEARNING_D_LCQUESTION = DitaClass.getInstance(
    "+ topic/p learningInteractionBase-d/lcQuestionBase learning-d/lcQuestion "
  );
  public static final DitaClass LEARNING_D_LCSEQUENCE = DitaClass.getInstance(
    "+ topic/data learningInteractionBase-d/data learning-d/lcSequence "
  );
  public static final DitaClass LEARNING_D_LCSEQUENCEOPTION = DitaClass.getInstance(
    "+ topic/li learningInteractionBase-d/li learning-d/lcSequenceOption "
  );
  public static final DitaClass LEARNING_D_LCSEQUENCEOPTIONGROUP = DitaClass.getInstance(
    "+ topic/ol learningInteractionBase-d/ol learning-d/lcSequenceOptionGroup "
  );
  public static final DitaClass LEARNING_D_LCSEQUENCING = DitaClass.getInstance(
    "+ topic/fig learningInteractionBase-d/lcInteractionBase learning-d/lcSequencing "
  );
  public static final DitaClass LEARNING_D_LCSINGLESELECT = DitaClass.getInstance(
    "+ topic/fig learningInteractionBase-d/lcInteractionBase learning-d/lcSingleSelect "
  );
  public static final DitaClass LEARNING_D_LCTRUEFALSE = DitaClass.getInstance(
    "+ topic/fig learningInteractionBase-d/lcInteractionBase learning-d/lcTrueFalse "
  );
  public static final DitaClass LEARNING2_D_LCANSWERCONTENT2 = DitaClass.getInstance(
    "+ topic/div learningInteractionBase2-d/div learning2-d/lcAnswerContent2 "
  );
  public static final DitaClass LEARNING2_D_LCANSWEROPTION2 = DitaClass.getInstance(
    "+ topic/li learningInteractionBase2-d/li learning2-d/lcAnswerOption2 "
  );
  public static final DitaClass LEARNING2_D_LCANSWEROPTIONGROUP2 = DitaClass.getInstance(
    "+ topic/ul learningInteractionBase2-d/ul learning2-d/lcAnswerOptionGroup2 "
  );
  public static final DitaClass LEARNING2_D_LCAREA2 = DitaClass.getInstance(
    "+ topic/figgroup learningInteractionBase2-d/figgroup learning2-d/lcArea2 "
  );
  public static final DitaClass LEARNING2_D_LCAREACOORDS2 = DitaClass.getInstance(
    "+ topic/ph learningInteractionBase2-d/ph learning2-d/lcAreaCoords2 "
  );
  public static final DitaClass LEARNING2_D_LCAREASHAPE2 = DitaClass.getInstance(
    "+ topic/keyword learningInteractionBase2-d/keyword learning2-d/lcAreaShape2 "
  );
  public static final DitaClass LEARNING2_D_LCASSET2 = DitaClass.getInstance(
    "+ topic/div learningInteractionBase2-d/div learning2-d/lcAsset2 "
  );
  public static final DitaClass LEARNING2_D_LCCORRECTRESPONSE2 = DitaClass.getInstance(
    "+ topic/data learningInteractionBase2-d/data learning2-d/lcCorrectResponse2 "
  );
  public static final DitaClass LEARNING2_D_LCFEEDBACK2 = DitaClass.getInstance(
    "+ topic/div learningInteractionBase2-d/div learning2-d/lcFeedback2 "
  );
  public static final DitaClass LEARNING2_D_LCFEEDBACKCORRECT2 = DitaClass.getInstance(
    "+ topic/div learningInteractionBase2-d/div learning2-d/lcFeedbackCorrect2 "
  );
  public static final DitaClass LEARNING2_D_LCFEEDBACKINCORRECT2 = DitaClass.getInstance(
    "+ topic/div learningInteractionBase2-d/div learning2-d/lcFeedbackIncorrect2 "
  );
  public static final DitaClass LEARNING2_D_LCHOTSPOT2 = DitaClass.getInstance(
    "+ topic/div learningInteractionBase2-d/lcInteractionBase2 learning2-d/lcHotspot2 "
  );
  public static final DitaClass LEARNING2_D_LCHOTSPOTMAP2 = DitaClass.getInstance(
    "+ topic/fig learningInteractionBase2-d/figgroup learning2-d/lcHotspotMap2 "
  );
  public static final DitaClass LEARNING2_D_LCINSTRUCTORNOTE2 = DitaClass.getInstance(
    "+ topic/note learningInteractionBase2-d/note learning2-d/lcInstructornote2 "
  );
  public static final DitaClass LEARNING2_D_LCITEM2 = DitaClass.getInstance(
    "+ topic/stentry learningInteractionBase2-d/stentry learning2-d/lcItem2 "
  );
  public static final DitaClass LEARNING2_D_LCMATCHING2 = DitaClass.getInstance(
    "+ topic/div learningInteractionBase2-d/lcInteractionBase2 learning2-d/lcMatching2 "
  );
  public static final DitaClass LEARNING2_D_LCMATCHINGHEADER2 = DitaClass.getInstance(
    "+ topic/sthead learningInteractionBase2-d/sthead learning2-d/lcMatchingHeader2 "
  );
  public static final DitaClass LEARNING2_D_LCMATCHINGITEM2 = DitaClass.getInstance(
    "+ topic/stentry learningInteractionBase2-d/stentry learning2-d/lcMatchingItem2 "
  );
  ...
  public static final DitaClass LEARNING2_D_LCMATCHINGPAIR2 = DitaClass.getInstance(
    "+ topic/strow learningInteractionBase2-d/strow learning2-d/lcMatchingPair2 "
  );
  ...
  public static final DitaClass LEARNING2_D_LCOPENANSWER2 = DitaClass.getInstance(
    "+ topic/div learningInteractionBase2-d/div learning2-d/lcOpenAnswer2 "
  );
  ...
  public static final DitaClass LEARNING2_D_LCQUESTION2 = DitaClass.getInstance(
    "+ topic/div learningInteractionBase2-d/lcQuestionBase2 learning2-d/lcQuestion2 "
  );
  public static final DitaClass LEARNING2_D_LCSEQUENCE2 = DitaClass.getInstance(
    "+ topic/data learningInteractionBase2-d/data learning2-d/lcSequence2 "
  );
  public static final DitaClass LEARNING2_D_LCSEQUENCEOPTION2 = DitaClass.getInstance(
    "+ topic/li learningInteractionBase2-d/li learning2-d/lcSequenceOption2 "
  );
  public static final DitaClass LEARNING2_D_LCSEQUENCEOPTIONGROUP2 = DitaClass.getInstance(
    "+ topic/ol learningInteractionBase2-d/ol learning2-d/lcSequenceOptionGroup2 "
  );
  ...
  public static final DitaClass LEARNINGASSESSMENT_LEARNINGASSESSMENT = DitaClass.getInstance(
  ...
  public static final DitaClass LEARNINGBASE_LCAUDIENCE = DitaClass.getInstance(
    "- topic/section learningBase/lcAudience "
  );
  public static final DitaClass LEARNINGBASE_LCCHALLENGE = DitaClass.getInstance(
    "- topic/section learningBase/lcChallenge "
  );
  public static final DitaClass LEARNINGBASE_LCDURATION = DitaClass.getInstance(
    "- topic/section learningBase/lcDuration "
  );
  public static final DitaClass LEARNINGBASE_LCINSTRUCTION = DitaClass.getInstance(
    "- topic/section learningBase/lcInstruction "
  );
  public static final DitaClass LEARNINGBASE_LCINTERACTION = DitaClass.getInstance(
  ...
  public static final DitaClass LEARNINGBASE_LCNEXTSTEPS = DitaClass.getInstance(
    "- topic/section learningBase/lcNextSteps "
  );
  public static final DitaClass LEARNINGBASE_LCOBJECTIVE = DitaClass.getInstance(
    "- topic/li learningBase/lcObjective "
  );
  public static final DitaClass LEARNINGBASE_LCOBJECTIVES = DitaClass.getInstance(
    "- topic/section learningBase/lcObjectives "
  );
  public static final DitaClass LEARNINGBASE_LCOBJECTIVESGROUP = DitaClass.getInstance(
    "- topic/ul learningBase/lcObjectivesGroup "
  );
  public static final DitaClass LEARNINGBASE_LCOBJECTIVESSTEM = DitaClass.getInstance(
    "- topic/ph learningBase/lcObjectivesStem "
  );
  public static final DitaClass LEARNINGBASE_LCPREREQS = DitaClass.getInstance(
    "- topic/section learningBase/lcPrereqs "
  );
  public static final DitaClass LEARNINGBASE_LCRESOURCES = DitaClass.getInstance(
  ...
  public static final DitaClass LEARNINGBASE_LCSUMMARY = DitaClass.getInstance(
  ...
  public static final DitaClass LEARNINGBASE_LEARNINGBASE = DitaClass.getInstance(
    "- topic/topic learningBase/learningBase "
  );
  public static final DitaClass LEARNINGBASE_LEARNINGBASEBODY = DitaClass.getInstance(
    "- topic/body learningBase/learningBasebody "
  );
  public static final DitaClass LEARNINGCONTENT_LEARNINGCONTENT = DitaClass.getInstance(
    "- topic/topic learningBase/learningBase learningContent/learningContent "
  );
  public static final DitaClass LEARNINGCONTENT_LEARNINGCONTENTBODY = DitaClass.getInstance(
    "- topic/body learningBase/learningBasebody learningContent/learningContentbody "
  );
  public static final DitaClass LEARNINGGROUPMAP_LEARNINGGROUPMAP = DitaClass.getInstance(
    "- map/map learningGroupMap/learningGroupMap "
  );
  public static final DitaClass LEARNINGINTERACTIONBASE_D_LCINTERACTIONBASE = DitaClass.getInstance(
    "+ topic/fig learningInteractionBase-d/lcInteractionBase "
  );
  public static final DitaClass LEARNINGINTERACTIONBASE_D_LCQUESTIONBASE = DitaClass.getInstance(
    "+ topic/p learningInteractionBase-d/lcQuestionBase "
  );
  public static final DitaClass LEARNINGINTERACTIONBASE2_D_LCINTERACTIONBASE2 = DitaClass.getInstance(
    "+ topic/div learningInteractionBase2-d/lcInteractionBase2 "
  );
  public static final DitaClass LEARNINGINTERACTIONBASE2_D_LCINTERACTIONLABEL2 = DitaClass.getInstance(
    "+ topic/p learningInteractionBase2-d/lcInteractionLabel2 "
  );
  public static final DitaClass LEARNINGINTERACTIONBASE2_D_LCQUESTIONBASE2 = DitaClass.getInstance(
    "+ topic/div learningInteractionBase2-d/lcQuestionBase2 "
  );
  public static final DitaClass LEARNINGMAP_D_LEARNINGCONTENTCOMPONENTREF = DitaClass.getInstance(
    "+ map/topicref learningmap-d/learningContentComponentRef "
  );
  public static final DitaClass LEARNINGMAP_D_LEARNINGCONTENTREF = DitaClass.getInstance(
    "+ map/topicref learningmap-d/learningContentRef "
  );
  public static final DitaClass LEARNINGMAP_D_LEARNINGGROUP = DitaClass.getInstance(
    "+ map/topicref learningmap-d/learningGroup "
  );
  public static final DitaClass LEARNINGMAP_D_LEARNINGGROUPMAPREF = DitaClass.getInstance(
    "+ map/topicref learningmap-d/learningGroupMapRef "
  );
  public static final DitaClass LEARNINGMAP_D_LEARNINGOBJECT = DitaClass.getInstance(
    "+ map/topicref learningmap-d/learningObject "
  );
  public static final DitaClass LEARNINGMAP_D_LEARNINGOBJECTMAPREF = DitaClass.getInstance(
    "+ map/topicref learningmap-d/learningObjectMapRef "
  );
  public static final DitaClass LEARNINGMAP_D_LEARNINGOVERVIEWREF = DitaClass.getInstance(
    "+ map/topicref learningmap-d/learningOverviewRef "
  );
  public static final DitaClass LEARNINGMAP_D_LEARNINGPLANREF = DitaClass.getInstance(
    "+ map/topicref learningmap-d/learningPlanRef "
  );
  public static final DitaClass LEARNINGMAP_D_LEARNINGPOSTASSESSMENTREF = DitaClass.getInstance(
    "+ map/topicref learningmap-d/learningPostAssessmentRef "
  );
  public static final DitaClass LEARNINGMAP_D_LEARNINGPREASSESSMENTREF = DitaClass.getInstance(
    "+ map/topicref learningmap-d/learningPreAssessmentRef "
  );
  public static final DitaClass LEARNINGMAP_D_LEARNINGSUMMARYREF = DitaClass.getInstance(
  ...
  public static final DitaClass LEARNINGMETA_D_LOMAGGREGATIONLEVEL = DitaClass.getInstance(
    "+ topic/data learningmeta-d/lomAggregationLevel "
  );
  public static final DitaClass LEARNINGMETA_D_LOMCONTEXT = DitaClass.getInstance(
    "+ topic/data learningmeta-d/lomContext "
  );
  public static final DitaClass LEARNINGMETA_D_LOMCOVERAGE = DitaClass.getInstance(
    "+ topic/data learningmeta-d/lomCoverage "
  );
  public static final DitaClass LEARNINGMETA_D_LOMDIFFICULTY = DitaClass.getInstance(
    "+ topic/data learningmeta-d/lomDifficulty "
  );
  public static final DitaClass LEARNINGMETA_D_LOMINSTALLATIONREMARKS = DitaClass.getInstance(
    "+ topic/data learningmeta-d/lomInstallationRemarks "
  );
  public static final DitaClass LEARNINGMETA_D_LOMINTENDEDUSERROLE = DitaClass.getInstance(
    "+ topic/data learningmeta-d/lomIntendedUserRole "
  );
  public static final DitaClass LEARNINGMETA_D_LOMINTERACTIVITYLEVEL = DitaClass.getInstance(
    "+ topic/data learningmeta-d/lomInteractivityLevel "
  );
  public static final DitaClass LEARNINGMETA_D_LOMINTERACTIVITYTYPE = DitaClass.getInstance(
    "+ topic/data learningmeta-d/lomInteractivityType "
  );
  public static final DitaClass LEARNINGMETA_D_LOMLEARNINGRESOURCETYPE = DitaClass.getInstance(
    "+ topic/data learningmeta-d/lomLearningResourceType "
  );
  public static final DitaClass LEARNINGMETA_D_LOMOTHERPLATFORMREQUIREMENTS = DitaClass.getInstance(
    "+ topic/data learningmeta-d/lomOtherPlatformRequirements "
  );
  public static final DitaClass LEARNINGMETA_D_LOMSEMANTICDENSITY = DitaClass.getInstance(
    "+ topic/data learningmeta-d/lomSemanticDensity "
  );
  public static final DitaClass LEARNINGMETA_D_LOMSTRUCTURE = DitaClass.getInstance(
    "+ topic/data learningmeta-d/lomStructure "
  );
  public static final DitaClass LEARNINGMETA_D_LOMTECHREQUIREMENT = DitaClass.getInstance(
    "+ topic/data learningmeta-d/lomTechRequirement "
  );
  public static final DitaClass LEARNINGMETA_D_LOMTYPICALAGERANGE = DitaClass.getInstance(
    "+ topic/data learningmeta-d/lomTypicalAgeRange "
  );
  public static final DitaClass LEARNINGMETA_D_LOMTYPICALLEARNINGTIME = DitaClass.getInstance(
    "+ topic/data learningmeta-d/lomTypicalLearningTime "
  );
  public static final DitaClass LEARNINGOBJECTMAP_LEARNINGOBJECTMAP = DitaClass.getInstance(
    "- map/map learningObjectMap/learningObjectMap "
  );
  public static final DitaClass LEARNINGOVERVIEW_LEARNINGOVERVIEW = DitaClass.getInstance(
    "- topic/topic learningBase/learningBase learningOverview/learningOverview "
  );
  public static final DitaClass LEARNINGOVERVIEW_LEARNINGOVERVIEWBODY = DitaClass.getInstance(
    "- topic/body learningBase/learningBasebody learningOverview/learningOverviewbody "
  );
  public static final DitaClass LEARNINGPLAN_LCAGE = DitaClass.getInstance(
    "- topic/p learningBase/p learningPlan/lcAge "
  );
  public static final DitaClass LEARNINGPLAN_LCASSESSMENT = DitaClass.getInstance(
    "- topic/p learningBase/p learningPlan/lcAssessment "
  );
  public static final DitaClass LEARNINGPLAN_LCATTITUDE = DitaClass.getInstance(
    "- topic/p learningBase/p learningPlan/lcAttitude "
  );
  public static final DitaClass LEARNINGPLAN_LCBACKGROUND = DitaClass.getInstance(
    "- topic/p learningBase/p learningPlan/lcBackground "
  );
  public static final DitaClass LEARNINGPLAN_LCCIN = DitaClass.getInstance(
    "- topic/fig learningBase/fig learningPlan/lcCIN "
  );
  public static final DitaClass LEARNINGPLAN_LCCLASSROOM = DitaClass.getInstance(
    "- topic/fig learningBase/fig learningPlan/lcClassroom "
  );
  public static final DitaClass LEARNINGPLAN_LCCLIENT = DitaClass.getInstance(
    "- topic/fig learningBase/fig learningPlan/lcClient "
  );
  public static final DitaClass LEARNINGPLAN_LCCONSTRAINTS = DitaClass.getInstance(
    "- topic/fig learningBase/fig learningPlan/lcConstraints "
  );
  public static final DitaClass LEARNINGPLAN_LCDELIVDATE = DitaClass.getInstance(
    "- topic/fig learningBase/fig learningPlan/lcDelivDate "
  );
  public static final DitaClass LEARNINGPLAN_LCDELIVERY = DitaClass.getInstance(
    "- topic/p learningBase/p learningPlan/lcDelivery "
  );
  public static final DitaClass LEARNINGPLAN_LCDOWNLOADTIME = DitaClass.getInstance(
    "- topic/fig learningBase/fig learningPlan/lcDownloadTime "
  );
  public static final DitaClass LEARNINGPLAN_LCEDLEVEL = DitaClass.getInstance(
    "- topic/p learningBase/p learningPlan/lcEdLevel "
  );
  public static final DitaClass LEARNINGPLAN_LCFILESIZELIMITATIONS = DitaClass.getInstance(
    "- topic/fig learningBase/fig learningPlan/lcFileSizeLimitations "
  );
  public static final DitaClass LEARNINGPLAN_LCGAPANALYSIS = DitaClass.getInstance(
    "- topic/section learningBase/section learningPlan/lcGapAnalysis "
  );
  public static final DitaClass LEARNINGPLAN_LCGAPITEM = DitaClass.getInstance(
    "- topic/fig learningBase/fig learningPlan/lcGapItem "
  );
  public static final DitaClass LEARNINGPLAN_LCGAPITEMDELTA = DitaClass.getInstance(
    "- topic/p learningBase/p learningPlan/lcGapItemDelta "
  );
  public static final DitaClass LEARNINGPLAN_LCGENERALDESCRIPTION = DitaClass.getInstance(
    "- topic/p learningBase/p learningPlan/lcGeneralDescription "
  );
  public static final DitaClass LEARNINGPLAN_LCGOALS = DitaClass.getInstance(
    "- topic/p learningBase/p learningPlan/lcGoals "
  );
  public static final DitaClass LEARNINGPLAN_LCGRAPHICS = DitaClass.getInstance(
    "- topic/fig learningBase/fig learningPlan/lcGraphics "
  );
  public static final DitaClass LEARNINGPLAN_LCHANDOUTS = DitaClass.getInstance(
    "- topic/fig learningBase/fig learningPlan/lcHandouts "
  );
  public static final DitaClass LEARNINGPLAN_LCINTERVENTION = DitaClass.getInstance(
    "- topic/section learningBase/section learningPlan/lcIntervention "
  );
  public static final DitaClass LEARNINGPLAN_LCINTERVENTIONITEM = DitaClass.getInstance(
    "- topic/fig learningBase/fig learningPlan/lcInterventionItem "
  );
  public static final DitaClass LEARNINGPLAN_LCJTAITEM = DitaClass.getInstance(
    "- topic/p learningBase/p learningPlan/lcJtaItem "
  );
  public static final DitaClass LEARNINGPLAN_LCKNOWLEDGE = DitaClass.getInstance(
    "- topic/p learningBase/p learningPlan/lcKnowledge "
  );
  public static final DitaClass LEARNINGPLAN_LCLEARNSTRAT = DitaClass.getInstance(
    "- topic/p learningBase/p learningPlan/lcLearnStrat "
  );
  public static final DitaClass LEARNINGPLAN_LCLMS = DitaClass.getInstance(
    "- topic/fig learningBase/fig learningPlan/lcLMS "
  );
  public static final DitaClass LEARNINGPLAN_LCMODDATE = DitaClass.getInstance(
    "- topic/fig learningBase/fig learningPlan/lcModDate "
  );
  public static final DitaClass LEARNINGPLAN_LCMOTIVATION = DitaClass.getInstance(
    "- topic/p learningBase/p learningPlan/lcMotivation "
  );
  public static final DitaClass LEARNINGPLAN_LCNEEDS = DitaClass.getInstance(
    "- topic/p learningBase/p learningPlan/lcNeeds "
  );
  public static final DitaClass LEARNINGPLAN_LCNEEDSANALYSIS = DitaClass.getInstance(
    "- topic/section learningBase/section learningPlan/lcNeedsAnalysis "
  );
  public static final DitaClass LEARNINGPLAN_LCNOLMS = DitaClass.getInstance(
    "- topic/fig learningBase/fig learningPlan/lcNoLMS "
  );
  public static final DitaClass LEARNINGPLAN_LCOJT = DitaClass.getInstance(
    "- topic/fig learningBase/fig learningPlan/lcOJT "
  );
  public static final DitaClass LEARNINGPLAN_LCORGANIZATIONAL = DitaClass.getInstance(
    "- topic/fig learningBase/fig learningPlan/lcOrganizational "
  );
  public static final DitaClass LEARNINGPLAN_LCORGCONSTRAINTS = DitaClass.getInstance(
    "- topic/p learningBase/p learningPlan/lcOrgConstraints "
  );
  public static final DitaClass LEARNINGPLAN_LCPLANAUDIENCE = DitaClass.getInstance(
    "- topic/fig learningBase/fig learningPlan/lcPlanAudience "
  );
  public static final DitaClass LEARNINGPLAN_LCPLANDESCRIP = DitaClass.getInstance(
    "- topic/fig learningBase/fig learningPlan/lcPlanDescrip "
  );
  public static final DitaClass LEARNINGPLAN_LCPLANOBJECTIVE = DitaClass.getInstance(
    "- topic/p learningBase/p learningPlan/lcPlanObjective "
  );
  public static final DitaClass LEARNINGPLAN_LCPLANPREREQS = DitaClass.getInstance(
    "- topic/fig learningBase/fig learningPlan/lcPlanPrereqs "
  );
  public static final DitaClass LEARNINGPLAN_LCPLANRESOURCES = DitaClass.getInstance(
    "- topic/p learningBase/p learningPlan/lcPlanResources "
  );
  public static final DitaClass LEARNINGPLAN_LCPLANSUBJECT = DitaClass.getInstance(
    "- topic/fig learningBase/fig learningPlan/lcPlanSubject "
  );
  public static final DitaClass LEARNINGPLAN_LCPLANTITLE = DitaClass.getInstance(
    "- topic/fig learningBase/fig learningPlan/lcPlanTitle "
  );
  public static final DitaClass LEARNINGPLAN_LCPLAYERS = DitaClass.getInstance(
    "- topic/fig learningBase/fig learningPlan/lcPlayers "
  );
  public static final DitaClass LEARNINGPLAN_LCPROCESSES = DitaClass.getInstance(
    "- topic/p learningBase/p learningPlan/lcProcesses "
  );
  public static final DitaClass LEARNINGPLAN_LCPROJECT = DitaClass.getInstance(
    "- topic/section learningBase/section learningPlan/lcProject "
  );
  public static final DitaClass LEARNINGPLAN_LCRESOLUTION = DitaClass.getInstance(
    "- topic/fig learningBase/fig learningPlan/lcResolution "
  );
  public static final DitaClass LEARNINGPLAN_LCSECURITY = DitaClass.getInstance(
    "- topic/fig learningBase/fig learningPlan/lcSecurity "
  );
  public static final DitaClass LEARNINGPLAN_LCSKILLS = DitaClass.getInstance(
    "- topic/p learningBase/p learningPlan/lcSkills "
  );
  public static final DitaClass LEARNINGPLAN_LCSPECCHARS = DitaClass.getInstance(
    "- topic/p learningBase/p learningPlan/lcSpecChars "
  );
  public static final DitaClass LEARNINGPLAN_LCTASK = DitaClass.getInstance(
    "- topic/fig learningBase/fig learningPlan/lcTask "
  );
  public static final DitaClass LEARNINGPLAN_LCTASKITEM = DitaClass.getInstance(
    "- topic/p learningBase/p learningPlan/lcTaskItem "
  );
  public static final DitaClass LEARNINGPLAN_LCTECHNICAL = DitaClass.getInstance(
    "- topic/section learningBase/section learningPlan/lcTechnical "
  );
  public static final DitaClass LEARNINGPLAN_LCVALUES = DitaClass.getInstance(
    "- topic/p learningBase/p learningPlan/lcValues "
  );
  public static final DitaClass LEARNINGPLAN_LCVIEWERS = DitaClass.getInstance(
    "- topic/fig learningBase/fig learningPlan/lcViewers "
  );
  public static final DitaClass LEARNINGPLAN_LCW3C = DitaClass.getInstance(
    "- topic/fig learningBase/fig learningPlan/lcW3C "
  );
  public static final DitaClass LEARNINGPLAN_LCWORKENV = DitaClass.getInstance(
    "- topic/fig learningBase/fig learningPlan/lcWorkEnv "
  );
  public static final DitaClass LEARNINGPLAN_LCWORKENVDESCRIPTION = DitaClass.getInstance(
    "- topic/p learningBase/p learningPlan/lcWorkEnvDescription "
  );
  public static final DitaClass LEARNINGPLAN_LEARNINGPLAN = DitaClass.getInstance(
    "- topic/topic learningBase/learningBase learningPlan/learningPlan "
  );
  public static final DitaClass LEARNINGPLAN_LEARNINGPLANBODY = DitaClass.getInstance(
    "- topic/body learningBase/learningBasebody learningPlan/learningPlanbody "
  );
  public static final DitaClass LEARNINGSUMMARY_LEARNINGSUMMARY = DitaClass.getInstance(
    "- topic/topic learningBase/learningBase learningSummary/learningSummary "
  );
  public static final DitaClass LEARNINGSUMMARY_LEARNINGSUMMARYBODY = DitaClass.getInstance(
  ...
  public static final DitaClass MAPGROUP_D_TOPICSETREF = DitaClass.getInstance(
  ...
  public static final DitaClass REFERENCE_PROPERTIES = DitaClass.getInstance(
  ...
  public static final DitaClass RELMGMT_D_CHANGE_COMPLETED = DitaClass.getInstance(
    "+ topic/data relmgmt-d/change-completed "
  );
  public static final DitaClass RELMGMT_D_CHANGE_HISTORYLIST = DitaClass.getInstance(
  ...
  public static final DitaClass RELMGMT_D_CHANGE_ORGANIZATION = DitaClass.getInstance(
    "+ topic/data relmgmt-d/change-organization "
  );
  public static final DitaClass RELMGMT_D_CHANGE_PERSON = DitaClass.getInstance(
    "+ topic/data relmgmt-d/change-person "
  );
  public static final DitaClass RELMGMT_D_CHANGE_REQUEST_ID = DitaClass.getInstance(
    "+ topic/data relmgmt-d/change-request-id "
  );
  public static final DitaClass RELMGMT_D_CHANGE_REQUEST_REFERENCE = DitaClass.getInstance(
    "+ topic/data relmgmt-d/change-request-reference "
  );
  public static final DitaClass RELMGMT_D_CHANGE_REQUEST_SYSTEM = DitaClass.getInstance(
    "+ topic/data relmgmt-d/change-request-system "
  );
  public static final DitaClass RELMGMT_D_CHANGE_REVISIONID = DitaClass.getInstance(
    "+ topic/data relmgmt-d/change-revisionid "
  );
  public static final DitaClass RELMGMT_D_CHANGE_STARTED = DitaClass.getInstance(
    "+ topic/data relmgmt-d/change-started "
  );
  public static final DitaClass RELMGMT_D_CHANGE_SUMMARY = DitaClass.getInstance(
    "+ topic/data relmgmt-d/change-summary "
  );
  public static final DitaClass SUBJECTSCHEME_ATTRIBUTEDEF = DitaClass.getInstance(
    "- topic/data subjectScheme/attributedef "
  );
  public static final DitaClass SUBJECTSCHEME_DEFAULTSUBJECT = DitaClass.getInstance(
    "- map/topicref subjectScheme/defaultSubject "
  );
  public static final DitaClass SUBJECTSCHEME_ELEMENTDEF = DitaClass.getInstance(
    "- topic/data subjectScheme/elementdef "
  );
  public static final DitaClass SUBJECTSCHEME_ENUMERATIONDEF = DitaClass.getInstance(
    "- map/topicref subjectScheme/enumerationdef "
  );
  public static final DitaClass SUBJECTSCHEME_HASINSTANCE = DitaClass.getInstance(
  ...
  public static final DitaClass SUBJECTSCHEME_HASNARROWER = DitaClass.getInstance(
  ...
  public static final DitaClass SUBJECTSCHEME_HASRELATED = DitaClass.getInstance(
    "- map/topicref subjectScheme/hasRelated "
  );
  public static final DitaClass SUBJECTSCHEME_RELATEDSUBJECTS = DitaClass.getInstance(
    "- map/topicref subjectScheme/relatedSubjects "
  );
  public static final DitaClass SUBJECTSCHEME_SCHEMEREF = DitaClass.getInstance(
    "- map/topicref subjectScheme/schemeref "
  );
  public static final DitaClass SUBJECTSCHEME_SUBJECTDEF = DitaClass.getInstance(
    "- map/topicref subjectScheme/subjectdef "
  );
  public static final DitaClass SUBJECTSCHEME_SUBJECTHEAD = DitaClass.getInstance(
    "- map/topicref subjectScheme/subjectHead "
  );
  public static final DitaClass SUBJECTSCHEME_SUBJECTHEADMETA = DitaClass.getInstance(
    "- map/topicmeta subjectScheme/subjectHeadMeta "
  );
  public static final DitaClass SUBJECTSCHEME_SUBJECTREL = DitaClass.getInstance(
    "- map/relrow subjectScheme/subjectRel "
  );
  public static final DitaClass SUBJECTSCHEME_SUBJECTRELHEADER = DitaClass.getInstance(
    "- map/relrow subjectScheme/subjectRelHeader "
  );
  public static final DitaClass SUBJECTSCHEME_SUBJECTRELTABLE = DitaClass.getInstance(
    "- map/reltable subjectScheme/subjectRelTable "
  );
  public static final DitaClass SUBJECTSCHEME_SUBJECTROLE = DitaClass.getInstance(
    "- map/relcell subjectScheme/subjectRole "
  );
  public static final DitaClass SUBJECTSCHEME_SUBJECTSCHEME = DitaClass.getInstance(
  ...
  public static final DitaClass SYNTAX_D_GROUPCHOICE = DitaClass.getInstance(
    "+ topic/figgroup syntaxdiagram-d/groupchoice "
  );
  public static final DitaClass SYNTAX_D_GROUPCOMP = DitaClass.getInstance(
    "+ topic/figgroup syntaxdiagram-d/groupcomp "
  );
  ...
  public static final DitaClass SYNTAX_D_SYNTAXDIAGRAM = DitaClass.getInstance(
    "+ topic/fig syntaxdiagram-d/syntaxdiagram "
  );
  ...
  public static final DitaClass TASK_STEPTROUBLESHOOTING = DitaClass.getInstance(
  ...
  public static final DitaClass TASK_TASKTROUBLESHOOTING = DitaClass.getInstance(
  ...
  public static final DitaClass TASKREQ_D_CLOSEREQS = DitaClass.getInstance(
  ...
  public static final DitaClass TASKREQ_D_NOSPARES = DitaClass.getInstance(
  ...
  public static final DitaClass TASKREQ_D_NOSUPPLY = DitaClass.getInstance(
  ...
  public static final DitaClass TASKREQ_D_PRELREQS = DitaClass.getInstance(
  ...
  public static final DitaClass TROUBLESHOOTING_CONDITION = DitaClass.getInstance(
    "- topic/section troubleshooting/condition "
  );
  public static final DitaClass TROUBLESHOOTING_REMEDY = DitaClass.getInstance(
    "- topic/section troubleshooting/remedy "
  );
  public static final DitaClass TROUBLESHOOTING_RESPONSIBLEPARTY = DitaClass.getInstance(
    "- topic/p troubleshooting/responsibleParty "
  );
  public static final DitaClass TROUBLESHOOTING_TROUBLEBODY = DitaClass.getInstance(
    "- topic/body troubleshooting/troublebody "
  );
  public static final DitaClass TROUBLESHOOTING_TROUBLESHOOTING = DitaClass.getInstance(
    "- topic/topic troubleshooting/troubleshooting "
  );
  public static final DitaClass TROUBLESHOOTING_TROUBLESOLUTION = DitaClass.getInstance(
  ...
  public static final DitaClass XML_D_NUMCHARREF = DitaClass.getInstance(
    "+ topic/keyword markup-d/markupname xml-d/numcharref "
  );
  public static final DitaClass XML_D_PARAMETERENTITY = DitaClass.getInstance(
    "+ topic/keyword markup-d/markupname xml-d/parameterentity "
  );
  public static final DitaClass XML_D_TEXTENTITY = DitaClass.getInstance(
    "+ topic/keyword markup-d/markupname xml-d/textentity "
  );
  public static final DitaClass XML_D_XMLATT = DitaClass.getInstance(
    "+ topic/keyword markup-d/markupname xml-d/xmlatt "
  );
  public static final DitaClass XML_D_XMLELEMENT = DitaClass.getInstance(
    "+ topic/keyword markup-d/markupname xml-d/xmlelement "
  );
  public static final DitaClass XML_D_XMLNSNAME = DitaClass.getInstance(
  ...
  public static final DitaClass XNAL_D_ADMINISTRATIVEAREA = DitaClass.getInstance(
    "+ topic/ph xnal-d/administrativearea "
  );
  public static final DitaClass XNAL_D_AUTHORINFORMATION = DitaClass.getInstance(
  ...
  public static final DitaClass XNAL_D_GENERATIONIDENTIFIER = DitaClass.getInstance(
  ...
  public static final DitaClass XNAL_D_ORGANIZATIONINFO = DitaClass.getInstance(
  ...
  public static final DitaClass XNAL_D_ORGANIZATIONNAMEDETAILS = DitaClass.getInstance(
  ...
  public static final DitaClass DITA_OT_D_KEYDEF = DitaClass.getInstance(
    "+ map/topicref mapgroup-d/keydef ditaot-d/keydef "
  );
  public static final DitaClass DITA_OT_D_DITAVAL_STARTPROP = DitaClass.getInstance(
    "+ topic/foreign ditaot-d/ditaval-startprop "
  );
  public static final DitaClass DITA_OT_D_DITAVAL_ENDPROP = DitaClass.getInstance(
