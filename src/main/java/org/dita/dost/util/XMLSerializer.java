...
/**
 * XML serializer. Users a {@link javax.xml.transform.sax.TransformerHandler TransformerHandler} as
 * the underlying serializer.
 *
 * <p>When possible, use {@link javax.xml.stream.XMLStreamWriter XMLStreamWriter} instead.
 *
...
public class XMLSerializer {
   ...
   * @throws IllegalStateException if start element is not open
   */
  public void writeCharacters(final char[] ch, final int start, final int length)
      throws SAXException {
    if (elementStack.isEmpty()) {
      throw new IllegalStateException("Current state does not allow Character writing");
    }
