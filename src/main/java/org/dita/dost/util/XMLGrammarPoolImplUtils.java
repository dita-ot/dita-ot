...
public class XMLGrammarPoolImplUtils extends XMLGrammarPoolImpl {
  ...
  /**
   * @see
   *     org.apache.xerces.util.XMLGrammarPoolImpl#putGrammar(org.apache.xerces.xni.grammars.Grammar)
   */
  @Override
   ...
   * names(public id) for DTD grammars and the system id for Schema grammars. The application can
