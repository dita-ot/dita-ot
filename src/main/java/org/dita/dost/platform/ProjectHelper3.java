...
public class ProjectHelper3 extends ProjectHelper2 {
  ...
  //
  //  /**
  //   * Parse the given URL as an antlib descriptor and return the content as something that can be
  //   * turned into an Antlib task.
  //   *
  //   * <p>simply delegates to {@link #parseUnknownElement parseUnknownElement} if the resource
  //   * provides an URL and throws an exception otherwise.
  //   *
  //   * @since Ant 1.8.0
  //   */
  ...
  //      url = (URL) source;
  //      //        } else if (source instanceof JavaResource) {
  //      //            JavaResource javaResource = (JavaResource) source;
  //      //            try {
  //      //                url = new URL("classpath", null, javaResource.getName());
  //      //            } catch (MalformedURLException e) {
  //      //                throw new BuildException(e);
  //      //            }
  //      //            URLProvider up = javaResource.as(URLProvider.class);
  //      //            if (up != null) {
  //      //                url = up.getURL();
  //      //            }
  ...
  //      }
  //      project.log(
  //        "parsing buildfile " + buildFileName + " with URI = " + uri + (zf != null ? " from a zip file" : ""),
  //        Project.MSG_VERBOSE
  //      );
  ...
  //      if (t instanceof BuildException be) {
  ...
  public static class RootHandler extends DefaultHandler {
    ...
    private final Stack<AntHandler> antHandlers = new Stack<>();
  ...
  //                ) {
  //                  String newTargetPrefix = getCurrentTargetPrefix()
  //                    .replace(ProjectHelper.USE_PROJECT_NAME_AS_TARGET_PREFIX, value);
  ...
  //            }
  //          }
  //          default -> throw new SAXParseException( // TODO ignore attributes in a different NS ( maybe store them ? )
  //            "Unexpected attribute \"" + attrs.getQName(i) + "\"",
  //            context.getLocator()
  //          );
  //        }
  //      }
  ...
  //              "failed to parse " + dup + " as URL while looking" + " at a duplicate project" + " name.",
  //              mue
  //            );
  //          }
  ...
  //    public AntHandler onStartChild(String uri, String name, String qname, Attributes attrs, AntXMLContext context)
  //      throws SAXParseException {
  //      return ((name.equals("target") || name.equals("extension-point")) && (uri.equals("") || uri.equals(ANT_CORE_URI)))
  //        ? targetHandler
  //        : elementHandler;
  //    }
  //  }
  ...
  //            }
  //          }
  //          case "depends" -> depends = value;
  //          case "if" -> target.setIf(value);
  //          case "unless" -> target.setUnless(value);
  //          case "id" -> {
  //            if (value != null && !value.equals("")) {
  //              context.getProject().addReference(value, target);
  //            }
  //          }
  //          case "description" -> target.setDescription(value);
  //          case "extensionOf" -> extensionPoint = value;
  ...
  //            }
  //          }
  //          default -> throw new SAXParseException("Unexpected attribute \"" + key + "\"", context.getLocator());
  //        }
  //      }
  //      if (name == null) {
  ...
  //            helper
  //              .getExtensionStack()
  //              .add(new String[] { extPointName, target.getName(), extensionPointMissing.name(), prefix + sep });
  //          } else {
  //            helper
  //              .getExtensionStack()
