...
/**
 * InsertDependsAction implements IAction. Parses an attribute value containing comma-separated
 * identifiers. Identifiers inside braces are replaced with the plugin features for the
