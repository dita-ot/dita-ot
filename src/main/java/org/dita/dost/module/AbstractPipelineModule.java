...
/**
 * Abstract class for Modules which contains the method that every module class should implement.
 *
 * @author Lian, Li
 */
public interface AbstractPipelineModule {
   ...
   *
   * <p>{@link #setLogger(DITAOTLogger)} must be called before calling this method.
   *
   * @param input input
   * @return output
