...
public final class ModuleFactory {
  ...
  /**
   * Method to get the only instance of ModuleFactory. ModuleFactory is a singleton class.
   *
   ...
   * @since 1.6
   */
  public AbstractPipelineModule createModule(
      final Class<? extends AbstractPipelineModule> moduleClass) throws DITAOTException {
    try {
