...
/**
 * MoveLinksModule implements move links step in preprocess. It reads the map links information from
 * the input map and inserts the links into topics.
 */
  ...
  public AbstractPipelineOutput execute(final AbstractPipelineInput input) throws DITAOTException {
    ...
    try {
      ...
      throw new DITAOTException(
          "Failed to read links from " + inputFile + ": " + e.getMessage(), e);
    }
