...
public final class DITAOTException extends Exception {
  ...
  /** serial version. */
  @Serial private static final long serialVersionUID = -7505646495801170017L;
  /** message bean. */
  private MessageBean messageBean = null;
  /** capture flag. */
  private final boolean captured = false;

  /** Constructs a new DITAOTException with {@code null} as its detail message. */
  ...
  /**
   * Constructs a new exception with cause, using location information from a root {@link
   * XPathException}
   *
   * @param cause the cause
   */
  ...
  /**
   * Constructs a new exception with the specified detail message and cause, using location
   * information from a root {@link XPathException}
   *
   * @param message the detail message.
   * @param cause the cause
   */
  public DITAOTException(final String message, final UncheckedXPathException cause) {
    super(
        message + ": " + cause.getXPathException().getMessageAndLocation(),
        cause.getXPathException());
  }
