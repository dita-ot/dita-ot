 ...
 *
 * <p>The following attributes are added to elements:
 *
 * <dl>
 *   <dt>{@link org.dita.dost.util.Constants#ATTRIBUTE_NAME_XTRF xtrf}
 *   <dd>Absolute system path of the source file.
 *   <dt>{@link org.dita.dost.util.Constants#ATTRIBUTE_NAME_XTRC xtrc}
 *   <dd>Element location in the document, {@code element-name ":" element-count ";" row-number ":"
 *       colum-number}.
 * </dl>
 */
