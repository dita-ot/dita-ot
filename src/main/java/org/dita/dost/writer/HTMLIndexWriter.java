...
/**
 * This class extends AbstractWriter, used to output IndexTerm list to CHM index file.
 *
 * @version 1.0 2005-05-11
 * @author Anders Svensson (based on modifications of the CHMIndexWriter class by Wu, Zhi Qiang) The
 *     class outputs an index for html, including alphabetical headings. (Thanks to pre-existing
 *     functionality in DITA OT, these will be sorted based on locale as long as the xml:lang
 *     attribute is used.)
 */
...
public final class HTMLIndexWriter extends AbstractExtendDitaWriter {
   ...
   */
  private void outputIndexTerm(final IndexTerm term, final XMLSerializer serializer)
      throws SAXException {
