 ...
 *
 * <ul>
 *   <li>Add default metadata {@code cascade} attribute value.
 *   <li>Strip redundant whitespace from {@code domains} attribute value.
 * </ul>
 */
  ...
  public void startElement(
    ...
    if (MAP_MAP.matches(cls) || TOPIC_TOPIC.matches(cls)) {
      ...
      if (domains != null) {
        ...
        XMLUtils.addOrSetAttribute(
            res, ATTRIBUTE_NAME_SPECIALIZATIONS, domainsToSpecializations(normalized));
      }
      ...
      if (specializations != null) {
        ...
        XMLUtils.addOrSetAttribute(
            res, ATTRIBUTE_NAME_DOMAINS, specializationsToDomains(normalized));
      }
    }
