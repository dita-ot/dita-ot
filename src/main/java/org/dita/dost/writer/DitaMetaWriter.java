...
public final class DitaMetaWriter extends AbstractDitaMetaWriter {
  ...
  private static final List<DitaClass> prologOrder =
      Collections.unmodifiableList(
          Arrays.asList(
              TOPIC_AUTHOR,
              TOPIC_SOURCE,
              ...
              TOPIC_FOREIGN,
              TOPIC_UNKNOWN));
  private static final List<DitaClass> metadataPosition =
      Collections.unmodifiableList(
          Arrays.asList(
              TOPIC_AUTHOR,
              TOPIC_SOURCE,
              ...
              TOPIC_CRITDATES,
              TOPIC_PERMISSIONS));
  private static final List<DitaClass> metadataOrder =
      Collections.unmodifiableList(
          Arrays.asList(
              TOPIC_AUDIENCE, TOPIC_CATEGORY, TOPIC_KEYWORDS, TOPIC_PRODINFO, TOPIC_OTHERMETA));
