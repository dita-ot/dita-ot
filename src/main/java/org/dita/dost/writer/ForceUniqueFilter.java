...
public final class ForceUniqueFilter extends AbstractXMLFilter {
  ...
  public void startElement(
      ...
      throws SAXException {
    ignoreStack.push(
        MAP_RELTABLE.matches(atts) ? false : ignoreStack.isEmpty() || ignoreStack.peek());
    ...
    if (ignoreStack.peek() && MAP_TOPICREF.matches(res)) {
      ...
      topicrefParentsStack.push(
          new ParentTopicref(href, dstFi, currentScope, currentProcesingResource));
    }
