...
/**
 * This class extends SAX's DefaultHandler, used for parse index term from dita files.
 *
...
public final class IndexTermReader extends AbstractXMLReader {
  ...
  public void endElement(final String uri, final String localName, final String qName)
    ...
    if (indexSeeSpecList.contains(localName) || indexSeeAlsoSpecList.contains(localName)) {
      ...
      term.addTarget(
          genTarget()); // assign current topic as the target of index-see or index-see-also term
      parentTerm.addSubTerm(term);
    }
  ...
  /**
   * Trim whitespace from start of the string. If last character of termName and first character of
   * temp is a space character, remove leading string from temp
   *
