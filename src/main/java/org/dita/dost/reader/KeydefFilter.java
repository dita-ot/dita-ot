...
/**
 * This class extends AbstractReader, used to parse relevant dita topics and ditamap files for
 * GenMapAndTopicListModule.
 *
 * <p><strong>Not thread-safe</strong>. Instances can be reused by calling {@link #reset()} between
 * calls to {@link org.xml.sax.XMLReader#parse(InputSource)}.
 */
public final class KeydefFilter extends AbstractXMLFilter {
  ...
  private void checkMultiLevelKeys(
      final Map<String, KeyDef> keysDefMap, final Map<String, String> keysRefMap) {
    String key;
    KeyDef value;
