...
public class StreamStore extends AbstractStore implements Store {
  ...
  @Override
  public void transform(final URI input, final ContentHandler contentHandler)
  ...
  @Override
  void transformURI(final URI input, final URI output, final List<XMLFilter> filters)
      throws DITAOTException {
    try {
  ...
  @Override
  public void transform(final URI input, final URI output, final XsltTransformer transformer)
      throws DITAOTException {
  ...
  @Override
  void transformUri(final URI src, final URI dst, final XsltTransformer transformer)
      throws DITAOTException {
    try {
  ...
  @Override
  public ContentHandler getContentHandler(final URI outputFile)
      throws SaxonApiException, IOException {
    final net.sf.saxon.Configuration configuration =
        xmlUtils.getProcessor().getUnderlyingConfiguration();
  ...
  public void copy(final URI src, final URI dst) throws IOException {
    if (Objects.equals(src.getScheme(), "file") && Objects.equals(dst.getScheme(), "file")) {
      final File s =
          new File(getUri((src.isAbsolute() ? src : tempDirUri.resolve(src)).normalize()));
      final File d =
          new File(getUri((dst.isAbsolute() ? dst : tempDirUri.resolve(dst)).normalize()));
      copyFile(s, d);
    } else {
