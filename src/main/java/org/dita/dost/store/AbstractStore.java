...
public abstract class AbstractStore implements Store {
  ...
  abstract void transformURI(final URI input, final URI output, final List<XMLFilter> filters)
      throws DITAOTException;
  ...
  //    @Override
  //    public void transform(final URI src, final URI outputFile, final List<XMLFilter> filters)
  // throws DITAOTException {
  //        try {
  //            final IdentityTransformer serializer = (IdentityTransformer) tf.newTransformer();
  //            serializer.getConfiguration().setErrorListener(new ErrorGatherer(new
  // ArrayList<>()));
  //            final URIResolver resolver = new
  // DelegatingURIResolver(CatalogUtils.getCatalogResolver(), this);
