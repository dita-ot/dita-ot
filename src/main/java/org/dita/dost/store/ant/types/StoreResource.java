...
//        ResourceFactory
{
  ...
  /**
   * Get the name of this StoreResource. If the basedir is set, the name will be relative to that.
   * Otherwise the basename only will be returned.
   *
   ...
   * @throws UnsupportedOperationException if OutputStreams are not supported for this Resource
   *     type.
   */
  @Override
   ...
   * @return a negative integer, zero, or a positive integer as this StoreResource is less than,
