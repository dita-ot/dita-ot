 ...
 * Abstract XML I/O.
 *
 * <p>The following file-system like operations are provided:
 *
 * <ul>
 *   <li>read
 *   <li>write
 *   <li>test for existence
 * </ul>
 *
 * <p>The following convenience operations are provided:
 *
 * <ul>
 *   <li>copy
 *   <li>move
...
public interface Store extends URIResolver {
   ...
   * @param filters XML filters to transform file with, may be an empty list
   */
  void transform(final URI src, final URI dst, final List<XMLFilter> filters)
   ...
   * @param transformer XSLT transformer to transform file with
   */
  void transform(final URI src, final URI dst, final XsltTransformer transformer)
      throws DITAOTException;
  ...
  /**
   * Get immutable DOM document for resource. If mutating methods are called, {@link
