...
import static org.dita.dost.chunk.ChunkMapFilter.*;
 ...
 */
final class ChunkTopicParser extends AbstractChunkTopicParser {
        ...
        try {
            ...
            if (topicref.hasChildNodes()) {
                ...
                if (parentResult.length() > 0
                    ...
                    insertIntoRoot(hrefValue, parentResult, tmpContent);
                // replace contents
                } else {
    ...
    /**
     * Append XML content into the end of root element.
     *
     * @param hrefValue    href of the topicref
     * @param parentResult XML content to insert into
     * @param tmpContent   XML content to insert
     */
    private void insertIntoRoot(final URI hrefValue, final StringBuffer parentResult, final CharSequence tmpContent) {
