...
abstract class Arguments {
  ...
  /**
   * The Ant logger class. There may be only one logger. It will have the right to use the 'out'
   * PrintStream. The class must implements the BuildLogger interface.
   */
  ...
  static class BooleanArgument extends Argument {
    ...
    BooleanArgument(
        final String property, final String desc, final String trueValue, final String falseValue) {
      super(property, desc);
