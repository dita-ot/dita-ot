 ...
 *
 * <p>This task can accept the following attributes:
 *
 * <ul>
 *   <li>file
 *   <li>property
 ...
 *
 * <p>When this task executes, it will set the specified property to the value of the last element
 * in the specified file. If file is a directory, the basename will be the last directory element.
 * If file is a full-path filename, the basename will be the simple file name. If a suffix is
 * specified, and the specified file ends in that suffix, the basename will be the simple file name
 * without the suffix.
 *
 * <p>
 *
