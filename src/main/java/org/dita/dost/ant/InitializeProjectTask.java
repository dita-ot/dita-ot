...
public final class InitializeProjectTask extends Task {
  ...
  private static final ServiceLoader<StoreBuilder> storeBuilderLoader =
      ServiceLoader.load(StoreBuilder.class);
  ...
  public void execute() throws BuildException {
    ...
    if (!ditaDir.isAbsolute()) {
      throw new IllegalArgumentException(
          "DITA-OT installation directory " + ditaDir + " must be absolute");
    }
