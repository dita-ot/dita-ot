...
public class KeyrefPaserTest {
  ...
  public void testTopicWriteSubdir() throws Exception {
    ...
    assertXMLEqual(
        new InputSource(
            new File(expDir + File.separator + "subdir", "subdirtopic.xml").toURI().toString()),
  ...
  public void testUpLevelMapWrite() throws Exception {
    ...
    assertXMLEqual(
        new InputSource(
            new File(expDir, "subdir" + File.separator + "c.ditamap").toURI().toString()),
        new InputSource(
            new File(tempDir, "subdir" + File.separator + "c.ditamap").toURI().toString()));
  }
