...
public class ValidationFilterTest {
  ...
  public void testXMLLang() throws SAXException {
    ...
    f.startElement(
        NULL_NS_URI, "x", "x", new AttributesBuilder().add(XML_NS_URI, "lang", "en_us").build());
    f.startElement(
        NULL_NS_URI, "x", "x", new AttributesBuilder().add(XML_NS_URI, "lang", "en-GB").build());
  ...
  public void testScope() throws SAXException, URISyntaxException {
    ...
    f.startElement(
        ...
        TOPIC_XREF.localName,
        TOPIC_XREF.localName,
        new AttributesBuilder().add(ATTRIBUTE_NAME_HREF, "http://example.com/broken").build());
    f.startElement(
        NULL_NS_URI,
        TOPIC_XREF.localName,
        TOPIC_XREF.localName,
