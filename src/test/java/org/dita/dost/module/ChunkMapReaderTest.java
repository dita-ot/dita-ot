...
public class ChunkMapReaderTest {
  ...
  public void testchunk_map_tocontent() {
    test(
        ...
        ImmutableMap.<String, String>builder()
            .put(
                "chunk_map_tocontent/dita1.dita#topicID1",
                "chunk_map_tocontent/Chunk0.dita#topicID1")
            ...
            .put(
                "chunk_map_tocontent/dita2.dita#topicID1",
                "chunk_map_tocontent/Chunk1.dita#topicID1")
            .put(
  ...
  private void test(
      final String testCase, final Map<String, String> change, final Map<String, String> conflict) {
