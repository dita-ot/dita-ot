...
public class ChunkMapFilter2Test {

    final File resourceDir = TestUtils.getResourceDir(org.dita.dost.module.ChunkMapReaderTest.class);
    ...
    public void testRead() throws Exception {
        ...
        final ChunkMapFilter mapReader = new ChunkMapFilter();
