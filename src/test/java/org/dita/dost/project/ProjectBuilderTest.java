...
public class ProjectBuilderTest {
  ...
  public static Collection<String[]> data() {
    return Arrays.asList(
        new String[][] {{"simple"}, {"common"}, {"product"}, {"root"}, {"minimal"}, {"multiple"}});
  }
  ...
  public void deserializeJson() throws IOException {
    try (InputStream in =
        getClass()
            .getClassLoader()
            .getResourceAsStream("org/dita/dost/project/" + name + ".json")) {
  ...
  public void deserializeYaml() throws IOException {
    try (InputStream in =
        getClass()
            .getClassLoader()
            .getResourceAsStream("org/dita/dost/project/" + name + ".yaml")) {
