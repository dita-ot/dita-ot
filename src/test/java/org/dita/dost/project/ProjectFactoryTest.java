...
public class ProjectFactoryTest {
  ...
  public void resolveReferences_deliverable() {
    final Project src =
        new Project(
            singletonList(
                new Deliverable(
                    null, null, null, null, new Publication(null, null, "id", null, null, null))),
            null,
  ...
  public void resolveReferences_context() {
    final Project src =
        new Project(
            singletonList(
                new Deliverable(null, null, new Context(null, null, "id", null, null), null, null)),
            null,
            null,
        ...
        new Project(
            singletonList(
                new Deliverable(
                    ...
                    null,
                    null,
                    new Publication(null, null, "missing", null, null, null))),
            null,
  ...
  public void read() throws IOException, URISyntaxException, SAXException {
    final URI file =
        getClass().getClassLoader().getResource("org/dita/dost/project/simple.json").toURI();
    final Project project = factory.load(file);
    assertEquals(1, project.deliverables().size());
    assertTrue(
        project.deliverables().get(0).context().inputs().inputs().get(0).href().isAbsolute());
  ...
  public void readMultiple() throws IOException, URISyntaxException, SAXException {
    final URI file =
        getClass().getClassLoader().getResource("org/dita/dost/project/multiple.json").toURI();
    final Project project = factory.load(file);
    assertEquals(1, project.deliverables().size());
    assertTrue(
        project.deliverables().get(0).context().inputs().inputs().get(0).href().isAbsolute());
  ...
  public void deserializeJsonRoot() throws IOException, URISyntaxException, SAXException {
    final URI input =
        getClass().getClassLoader().getResource("org/dita/dost/project/root.json").toURI();
  ...
  public void deserializeJsonProduct() throws IOException, URISyntaxException, SAXException {
    final URI input =
        getClass().getClassLoader().getResource("org/dita/dost/project/product.json").toURI();
    final Project project = factory.load(input);
    assertEquals(1, project.deliverables().size());
  ...
  public void deserializeJsonRecursive() throws IOException, URISyntaxException, SAXException {
    final URI input =
        getClass().getClassLoader().getResource("org/dita/dost/project/recursive.json").toURI();
    factory.load(input);
  }
}
