...
public class XmlReaderTest {
  ...
  public void deserializeXmlSimple() throws IOException, SAXException {
    try (InputStream in =
        getClass().getClassLoader().getResourceAsStream("org/dita/dost/project/simple.xml")) {
      final ProjectBuilder project =
          xmlReader.read(in, URI.create("classpath:org/dita/dost/project/simple.xml"));
  ...
  public void deserializeXmlProduct() throws IOException, SAXException {
    try (InputStream input =
        getClass().getClassLoader().getResourceAsStream("org/dita/dost/project/product.xml")) {
  ...
  public void deserializeXmlMinimal() throws IOException, SAXException {
    try (InputStream input =
        getClass().getClassLoader().getResourceAsStream("org/dita/dost/project/minimal.xml")) {
      final ProjectBuilder project = xmlReader.read(input, null);
      assertEquals(1, project.deliverables.size());
    }
  }
  ...
  public void deserializeXmlForeign() throws IOException, SAXException {
    try (InputStream input =
        getClass().getClassLoader().getResourceAsStream("org/dita/dost/project/foreign.xml")) {
