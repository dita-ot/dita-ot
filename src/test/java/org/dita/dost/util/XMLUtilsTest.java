...
public class XMLUtilsTest {
  ...
  public void configureCollationResolvers() {
    ...
    assertTrue(
        collationURIResolver.getClass().isAssignableFrom(DelegatingCollationUriResolverTest.class));
  }
  ...
  public void toMessageListener_withLevel() throws SaxonApiException {
    ...
    final XdmNode msg =
        Saplings.doc()
            .withChild(
                Saplings.pi("level", "ERROR"), Saplings.text("message "), Saplings.elem("debug"))
            .toXdmNode(new XMLUtils().getProcessor());
  ...
  public void toErrorReporter_location() {
    ...
    errorReporter.report(
        new XmlProcessingException(new XPathException("msg", null, Loc.makeFromSax(loc))));
  ...
  //                }
  //            }));
  //        TestUtils.assertXMLEqual(new InputSource(new File(expDir,
  // "order.dita").toURI().toString()),
