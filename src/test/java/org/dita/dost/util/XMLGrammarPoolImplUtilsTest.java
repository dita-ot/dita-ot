...
public class XMLGrammarPoolImplUtilsTest {
  ...
  public void testCompareDescriptorsByPublicID_same() {
    final XMLDTDDescription desc1 =
        getXmldtdDescription("file:/foo/abc.xml", "file:/foo/abc.dtd", "publicID");
    final DTDGrammar exp = new DTDGrammar(null, desc1);
    utils.putGrammar(exp);

    final XMLDTDDescription desc2 =
        getXmldtdDescription("file:/abc.xml", "file:/abc.dtd", "publicID");
  ...
  public void testCompareDescriptorsByPublicID_different() {
    ...
    final XMLDTDDescription desc2 =
        getXmldtdDescription("file:/abc.xml", "file:/abc.dtd", "differentId");
    final Grammar act = utils.getGrammar(desc2);
  ...
  public void testCompareDescriptorsBySystemID_same() {
    final XMLDTDDescription desc1 =
        getXmldtdDescription("file:/foo/abc.xml", "file:/foo/abc.dtd", null);
    final DTDGrammar exp = new DTDGrammar(null, desc1);
    utils.putGrammar(exp);

    final XMLDTDDescription desc2 =
        getXmldtdDescription("file:/abc.xml", "file:/foo/abc.dtd", null);
    final Grammar act = utils.getGrammar(desc2);
