...
public class URLUtilsTest {
  ...
  public void testClean() {
    ...
    assertEquals(
        "http://www.example.com/foo/bar", URLUtils.clean("http://www.example.com/foo/bar"));
  }
  ...
  public void testDirectoryContains() throws URISyntaxException {
    ...
    assertFalse(
        URLUtils.directoryContains(new URI("file:/src/"), new URI("file:/src/../test.txt")));
  }
  ...
  public void testToFileUri() throws URISyntaxException {
    ...
    assertEquals(
        new File(File.separator + "foo bar.txt"), URLUtils.toFile(new URI("file:/foo%20bar.txt")));
    assertEquals(
        new File("foo" + File.separator + "bar.txt"), URLUtils.toFile(new URI("foo/bar.txt")));
    assertEquals(
  ...
  public void testFileToUri() throws URISyntaxException {
    ...
    assertEquals(
        new URI("foo/bar.txt"),
        URLUtils.toURI(new File("foo" + Constants.WINDOWS_SEPARATOR + "bar.txt")));
    assertEquals(new URI("foo%20bar.txt"), URLUtils.toURI(new File(" foo bar.txt ")));
  }
  ...
  public void testStringToUri() throws URISyntaxException {
    ...
    assertEquals(
        new URI("foo/bar.txt"), URLUtils.toURI("foo" + Constants.WINDOWS_SEPARATOR + "bar.txt"));
    assertEquals(new URI("foo%20bar.txt"), URLUtils.toURI(" foo bar.txt "));
  ...
  public void testGetRelativePathFromMap() throws URISyntaxException {
    ...
    assertEquals(
        new URI("../a.dita"),
        URLUtils.getRelativePath(new URI("file:/map/"), new URI("file:/a.dita")));
    assertEquals(
        new URI("a.dita"),
        URLUtils.getRelativePath(new URI("file:/map.ditamap"), new URI("file:/a.dita")));
    assertEquals(
        new URI("a.dita"),
        URLUtils.getRelativePath(
            new URI("file:/map1/map2/map.ditamap"), new URI("file:/map1/map2/a.dita")));
    assertEquals(
        new URI("a.dita"),
    ...
    assertEquals(
        new URI("map2/a.dita"),
        URLUtils.getRelativePath(
            new URI("file:/map1/map.ditamap"), new URI("file:/map1/map2/a.dita")));
    assertEquals(
        new URI("map2/a.dita"),
    ...
    assertEquals(
        new URI("a.dita"),
        URLUtils.getRelativePath(new URI("file:/a.dita"), new URI("file:/a.dita")));
    assertEquals(
        new URI("#bar"),
        URLUtils.getRelativePath(new URI("file:/a.dita#foo"), new URI("file:/a.dita#bar")));
    assertEquals(
        new URI("#bar"), URLUtils.getRelativePath(new URI("file:/a.dita"), new URI("#bar")));
    assertEquals(
        new URI("file://a.dita"),
    ...
    assertEquals(
        ...
        URLUtils.getRelativePath(
            new URI("http://localhost/map.ditamap"), new URI("http:///map.ditamap")));
  }
  ...
  public void testSetFragment() throws URISyntaxException {
    ...
    assertEquals(
        new URI("file:/foo/bar#baz"), URLUtils.setFragment(new URI("file:/foo/bar"), "baz"));
    ...
    assertEquals(
        new URI("file://localhost/foo/bar"),
        URLUtils.setFragment(new URI("file://localhost/foo/bar"), null));
  ...
  public void testRemoveFragment() throws URISyntaxException {
    ...
    assertEquals(
        new URI("file://localhost/foo/bar"),
        URLUtils.removeFragment(new URI("file://localhost/foo/bar")));
  ...
  public void testAddSuffix() throws URISyntaxException {
    ...
    assertEquals(
        new URI("baz.qux/foo-1.bar"), URLUtils.addSuffix(new URI("baz.qux/foo.bar"), "-1"));
  }
  ...
  public void addSuffixToPath() {
    assertEquals(
        URI.create("file:/foo/barquz.baz"),
        URLUtils.addSuffixToPath(URI.create("file:/foo/bar.baz"), "quz"));
    assertEquals(
        URI.create("file:/foo/barquz"),
        URLUtils.addSuffixToPath(URI.create("file:/foo/bar"), "quz"));
  }
}
