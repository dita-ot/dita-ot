...
public class TestFileUtils {
  ...
  public void testGetRelativePathFromMap() {
    ...
    assertEquals("d:\\a.dita", FileUtils.getRelativeUnixPath("c:\\map.ditamap", "d:\\a.dita"));
    assertEquals(
        "a.dita", FileUtils.getRelativeUnixPath("c:/map1/map2/map.ditamap", "c:/map1/map2/a.dita"));
    assertEquals(
        "a.dita",
        FileUtils.getRelativeUnixPath("c:\\map1\\map2\\map.ditamap", "c:\\map1\\map2\\a.dita"));
    assertEquals(
        "../topic/a.dita", FileUtils.getRelativeUnixPath("c:/map1/map.ditamap", "c:/topic/a.dita"));
    assertEquals(
        "../topic/a.dita",
        FileUtils.getRelativeUnixPath("c:\\map1\\map.ditamap", "c:\\topic\\a.dita"));
  }
  ...
  public void testGetRelativePathFromMapFileFile() {
    if (File.separator.equals(SEPARATOR_WINDOWS)) {
      ...
      assertEquals(
          ...
          FileUtils.getRelativePath(
              new File("c:\\map1\\map.ditamap"), new File("c:\\topic\\a.dita")));
      assertEquals(
      ...
      assertEquals(
          new File("a.dita"),
          FileUtils.getRelativePath(new File("/map.ditamap"), new File("/a.dita")));
      assertEquals(
          new File("a.dita"),
          FileUtils.getRelativePath(
              new File("/map1/map2/map.ditamap"), new File("/map1/map2/a.dita")));
      assertEquals(
          new File("../topic/a.dita"),
  ...
  public void testGetRelativePathFile() {
    if (File.separator.equals(SEPARATOR_WINDOWS)) {
      ...
      assertEquals(
          new File("..\\..\\"), FileUtils.getRelativePath(new File("map1\\map2\\map.ditamap")));
    } else {
      assertEquals(new File(".."), FileUtils.getRelativePath(new File("map/map.ditamap")));
      assertEquals(null, FileUtils.getRelativePath(new File("map.ditamap")));
      assertEquals(
  ...
  public void testGetPathtoProjectFile() {
    assertEquals(
        ...
        FileUtils.getRelativePath(
            new File(
                File.separator + "dir" + File.separator + "dir" + File.separator + "file.xml")));
    assertEquals(
        new File(".." + File.separator + ".." + File.separator),
        FileUtils.getRelativePath(
            new File("dir" + File.separator + "dir" + File.separator + "file.xml")));
    assertEquals(
  ...
  public void testResolveTopic() {
    if (File.separator.equals(SEPARATOR_WINDOWS)) {
      ...
      assertEquals(
          "c:\\dir\\file.xml#topicid", FileUtils.resolveTopic("c:\\dir", "file.xml#topicid"));
  ...
  public void testNormalizeDirectory() {
    if (File.separator.equals(SEPARATOR_WINDOWS)) {
      assertEquals(
          new File("c:\\dir1\\dir2\\file.xml"), FileUtils.resolve("c:\\dir1", "dir2\\file.xml"));
      assertEquals(
          new File("c:\\dir1\\file.xml"), FileUtils.resolve("c:\\dir1\\dir2", "..\\file.xml"));
      ...
      assertEquals(
          new File("c:\\file.xml"), FileUtils.resolve((String) null, "c:\\file.xml#topicid"));
    } else {
  ...
  public void testReplaceExtName() {
    ...
    assertEquals(
        "filename.dita#topicid", FileUtils.replaceExtension("filename.xml#topicid", extName));
    ...
    assertEquals(
        "file.name.dita#topicid", FileUtils.replaceExtension("file.name.xml#topicid", extName));
  ...
  public void testDirectoryContains() {
    ...
    assertFalse(
        FileUtils.directoryContains(srcDir, new File(srcDir, ".." + File.separator + "test.txt")));
  }
