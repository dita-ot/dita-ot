...
public class FileUtilsTest {
  ...
  public void testGetRelativePathFromMapFileFile() {
    if (File.separator.equals(SEPARATOR_WINDOWS)) {
      ...
      assertEquals(
        new File("a.dita"),
        FileUtils.getRelativePath(new File("c:\\map1\\map2\\map.ditamap"), new File("c:\\map1\\map2\\a.dita"))
      );
      assertEquals(
  ...
  public void testGetRelativePathFile() {
    if (File.separator.equals(SEPARATOR_WINDOWS)) {
      ...
      assertNull(FileUtils.getRelativePath(new File("map.ditamap")));
  ...
  public void testGetPathtoProjectFile() {
    assertEquals(
      ...
      FileUtils.getRelativePath(new File(File.separator + "dir" + File.separator + "dir" + File.separator + "file.xml"))
    );
    assertEquals(
      new File(".." + File.separator + ".." + File.separator),
  ...
  public void testGetFragmentStringString() {
    ...
    assertNull(FileUtils.getFragment("foo", null));
  }
