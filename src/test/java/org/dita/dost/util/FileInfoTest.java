...
public final class FileInfoTest {
    ...
    public void testFileConstructor() throws URISyntaxException {
        final FileInfo f = new FileInfo("foo" + File.separator + "bar");
        assertEquals("foo" + File.separator + "bar", f.file);
    ...
    @Test
    public void testIllegalFileConstructor() throws URISyntaxException {
        final FileInfo f = new FileInfo("foo" + URI_SEPARATOR + "bar");
        assertEquals("foo" + File.separator + "bar", f.file);
        assertEquals(new URI("foo" + URI_SEPARATOR + "bar"), f.uri);
    }
    ...
    public void testFileBuilder() throws URISyntaxException {
        final FileInfo f = new Builder().file("foo" + File.separator + "bar").build();
        assertEquals("foo" + File.separator + "bar", f.file);
        assertEquals(new URI("foo" + URI_SEPARATOR + "bar"), f.uri);
    }
