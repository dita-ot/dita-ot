...
public class TestGenListModuleReader {
  ...
  public void startElement_localImage() throws SAXException {
    ...
    assertEquals(
        ATTR_FORMAT_VALUE_IMAGE, reader.getNonConrefCopytoTargets().iterator().next().format);
    assertEquals(
  ...
  public void testParse() throws Exception {
    ...
    final Set<URI> nonConrefCopytoTargets =
        reader.getNonConrefCopytoTargets().stream()
            .map(r -> r.filename)
  ...
  public void testChunkParse() throws Exception {
    ...
    assertEquals(
        new HashSet(Arrays.asList(srcDirUri.resolve("maps/toolbars.dita"))),
        reader.getHrefTargets());
