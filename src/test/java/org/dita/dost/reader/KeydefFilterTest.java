...
public class KeydefFilterTest {
    ...
    public void testParse() throws Exception{
        ...
        expKeyDefMap.put("target_topic_1", new KeyDef("target_topic_1", toURI(new File(srcDir, "topics" + File.separator + "target-topic-a.xml").getAbsolutePath()), ATTR_SCOPE_VALUE_LOCAL, null));
        expKeyDefMap.put("target_topic_2", new KeyDef("target_topic_2", toURI(new File(srcDir, "topics" + File.separator + "target-topic-c.xml").getAbsolutePath()), ATTR_SCOPE_VALUE_LOCAL, null));
        expKeyDefMap.put("target_topic_3", new KeyDef("target_topic_1", toURI(new File(srcDir, "topics" + File.separator + "target-topic-a.xml").getAbsolutePath()), ATTR_SCOPE_VALUE_LOCAL, null));
        expKeyDefMap.put("target_topic_4", new KeyDef("target_topic_1", toURI(new File(srcDir, "topics" + File.separator + "target-topic-a.xml").getAbsolutePath()), ATTR_SCOPE_VALUE_LOCAL, null));
