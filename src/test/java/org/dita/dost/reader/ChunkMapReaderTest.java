...
public class ChunkMapReaderTest {
  ...
  public void testRead() throws Exception {
    ...
    TestUtils.copy(
        new File(srcDir, "gen.ditamap"),
        new File(tempDir, "maps" + File.separator + "gen.ditamap"));
    job.add(
  ...
  public void testMissingSource() throws Exception {
    ...
    assertEquals(
        ImmutableMap.<URI, URI>builder().put(prefixTemp("2.dita"), prefixTemp("2.dita")).build(),
  ...
  private Map<URI, URI> getActChangeTable() {
    ...
    b.put(
        prefixTemp("maps/6.dita#topic_qft_qwn_hv"),
        prefixTemp("maps/topics/7.dita#topic_qft_qwn_hv"));
    ...
    b.put(
        prefixTemp("maps/9.dita#topic_qft_qwn_hv"), prefixTemp("topics/10.dita#topic_qft_qwn_hv"));
    ...
    b.put(
        prefixTemp("maps/12.dita#topic_qft_qwn_hv"),
        prefixTemp("maps/Chunk4.dita#topic_qft_qwn_hv"));
    ...
    b.put(
        prefixTemp("maps/20.dita#topic_qft_qwn_hv"),
        prefixTemp("maps/topics/21.dita#topic_qft_qwn_hv"));
    ...
    b.put(
        prefixTemp("maps/23.dita#topic_qft_qwn_hv"), prefixTemp("topics/24.dita#topic_qft_qwn_hv"));
    ...
    b.put(
        prefixTemp("maps/26.dita#topic_qft_qwn_hv"),
        prefixTemp("maps/Chunk10.dita#topic_qft_qwn_hv"));
    ...
    b.put(
        prefixTemp("maps/34.dita#topic_qft_qwn_hv"),
        prefixTemp("maps/topics/35.dita#topic_qft_qwn_hv"));
    b.put(prefixTemp("maps/topics/36.dita"), prefixTemp("maps/topics/35.dita#unique_14"));
    b.put(
        prefixTemp("maps/topics/36.dita#topic_qft_qwn_hv"),
        prefixTemp("maps/topics/35.dita#unique_14"));
    ...
    b.put(
        prefixTemp("maps/37.dita#topic_qft_qwn_hv"), prefixTemp("topics/38.dita#topic_qft_qwn_hv"));
    b.put(prefixTemp("maps/topics/39.dita"), prefixTemp("topics/38.dita#unique_15"));
    b.put(
        prefixTemp("maps/topics/39.dita#topic_qft_qwn_hv"), prefixTemp("topics/38.dita#unique_15"));
    ...
    b.put(
        prefixTemp("maps/40.dita#topic_qft_qwn_hv"),
        prefixTemp("maps/Chunk16.dita#topic_qft_qwn_hv"));
    b.put(prefixTemp("maps/topics/41.dita"), prefixTemp("maps/Chunk16.dita#unique_17"));
    b.put(
        prefixTemp("maps/topics/41.dita#topic_qft_qwn_hv"),
        prefixTemp("maps/Chunk16.dita#unique_17"));
    ...
    b.put(
        prefixTemp("maps/48.dita#topic_qft_qwn_hv"),
        prefixTemp("maps/topics/49.dita#topic_qft_qwn_hv"));
    b.put(prefixTemp("topics/50.dita"), prefixTemp("maps/topics/49.dita#unique_20"));
    b.put(
        prefixTemp("topics/50.dita#topic_qft_qwn_hv"), prefixTemp("maps/topics/49.dita#unique_20"));
    ...
    b.put(
        prefixTemp("maps/51.dita#topic_qft_qwn_hv"), prefixTemp("topics/52.dita#topic_qft_qwn_hv"));
    ...
    b.put(
        prefixTemp("maps/54.dita#topic_qft_qwn_hv"),
        prefixTemp("maps/Chunk22.dita#topic_qft_qwn_hv"));
    ...
    b.put(
        prefixTemp("62.dita#topic_qft_qwn_hv"), prefixTemp("maps/topics/63.dita#topic_qft_qwn_hv"));
    ...
    b.put(
        prefixTemp("76.dita#topic_qft_qwn_hv"), prefixTemp("maps/topics/77.dita#topic_qft_qwn_hv"));
    ...
    b.put(
        prefixTemp("90.dita#topic_qft_qwn_hv"), prefixTemp("maps/topics/91.dita#topic_qft_qwn_hv"));
    b.put(prefixTemp("maps/topics/92.dita"), prefixTemp("maps/topics/91.dita#unique_38"));
    b.put(
        prefixTemp("maps/topics/92.dita#topic_qft_qwn_hv"),
        prefixTemp("maps/topics/91.dita#unique_38"));
    ...
    b.put(
        prefixTemp("maps/topics/95.dita#topic_qft_qwn_hv"), prefixTemp("topics/94.dita#unique_39"));
    ...
    b.put(
        prefixTemp("maps/topics/97.dita#topic_qft_qwn_hv"),
        prefixTemp("maps/Chunk40.dita#unique_41"));
    ...
    b.put(
        prefixTemp("104.dita#topic_qft_qwn_hv"),
        prefixTemp("maps/topics/105.dita#topic_qft_qwn_hv"));
    b.put(prefixTemp("topics/106.dita"), prefixTemp("maps/topics/105.dita#unique_44"));
    b.put(
        prefixTemp("topics/106.dita#topic_qft_qwn_hv"),
        prefixTemp("maps/topics/105.dita#unique_44"));
    ...
    b.put(
        prefixTemp("110.dita#topic_qft_qwn_hv"), prefixTemp("maps/Chunk46.dita#topic_qft_qwn_hv"));
    b.put(prefixTemp("topics/111.dita"), prefixTemp("maps/Chunk46.dita#unique_47"));
    b.put(
        prefixTemp("topics/111.dita#topic_qft_qwn_hv"), prefixTemp("maps/Chunk46.dita#unique_47"));
    ...
    b.put(
        prefixTemp("maps/topics/112.dita#topic_qft_qwn_hv"),
        prefixTemp("maps/113.dita#topic_qft_qwn_hv"));
    ...
    b.put(
        prefixTemp("maps/topics/115.dita#topic_qft_qwn_hv"),
        prefixTemp("116.dita#topic_qft_qwn_hv"));
    ...
    b.put(
        prefixTemp("maps/topics/118.dita#topic_qft_qwn_hv"),
        prefixTemp("maps/topics/119.dita#topic_qft_qwn_hv"));
    b.put(prefixTemp("maps/120.dita"), prefixTemp("maps/topics/119.dita#unique_50"));
    b.put(
        prefixTemp("maps/120.dita#topic_qft_qwn_hv"), prefixTemp("maps/topics/119.dita#unique_50"));
    ...
    b.put(
        prefixTemp("maps/topics/121.dita#topic_qft_qwn_hv"),
        prefixTemp("topics/122.dita#topic_qft_qwn_hv"));
    ...
    b.put(
        prefixTemp("maps/topics/124.dita#topic_qft_qwn_hv"),
        prefixTemp("maps/Chunk52.dita#topic_qft_qwn_hv"));
    ...
    b.put(
        prefixTemp("maps/topics/126.dita#topic_qft_qwn_hv"),
        prefixTemp("maps/127.dita#topic_qft_qwn_hv"));
    ...
    b.put(
        prefixTemp("maps/topics/129.dita#topic_qft_qwn_hv"),
        prefixTemp("130.dita#topic_qft_qwn_hv"));
    ...
    b.put(
        prefixTemp("maps/topics/132.dita#topic_qft_qwn_hv"),
        prefixTemp("maps/topics/133.dita#topic_qft_qwn_hv"));
    ...
    b.put(
        prefixTemp("maps/topics/135.dita#topic_qft_qwn_hv"),
        prefixTemp("topics/136.dita#topic_qft_qwn_hv"));
    ...
    b.put(
        prefixTemp("maps/topics/138.dita#topic_qft_qwn_hv"),
        prefixTemp("maps/Chunk58.dita#topic_qft_qwn_hv"));
    ...
    b.put(
        prefixTemp("maps/topics/140.dita#topic_qft_qwn_hv"),
        prefixTemp("maps/141.dita#topic_qft_qwn_hv"));
    b.put(prefixTemp("maps/topics/142.dita"), prefixTemp("maps/141.dita#unique_60"));
    b.put(
        prefixTemp("maps/topics/142.dita#topic_qft_qwn_hv"), prefixTemp("maps/141.dita#unique_60"));
    b.put(prefixTemp("144.dita"), prefixTemp("144.dita"));
    b.put(prefixTemp("maps/topics/143.dita"), prefixTemp("144.dita#topic_qft_qwn_hv"));
    b.put(
        prefixTemp("maps/topics/143.dita#topic_qft_qwn_hv"),
        prefixTemp("144.dita#topic_qft_qwn_hv"));
    ...
    b.put(
        prefixTemp("maps/topics/146.dita#topic_qft_qwn_hv"),
        prefixTemp("maps/topics/147.dita#topic_qft_qwn_hv"));
    b.put(prefixTemp("maps/topics/148.dita"), prefixTemp("maps/topics/147.dita#unique_62"));
    b.put(
        prefixTemp("maps/topics/148.dita#topic_qft_qwn_hv"),
        prefixTemp("maps/topics/147.dita#unique_62"));
    ...
    b.put(
        prefixTemp("maps/topics/149.dita#topic_qft_qwn_hv"),
        prefixTemp("topics/150.dita#topic_qft_qwn_hv"));
    b.put(prefixTemp("maps/topics/151.dita"), prefixTemp("topics/150.dita#unique_63"));
    b.put(
        prefixTemp("maps/topics/151.dita#topic_qft_qwn_hv"),
        prefixTemp("topics/150.dita#unique_63"));
    ...
    b.put(
        prefixTemp("maps/topics/152.dita#topic_qft_qwn_hv"),
        prefixTemp("maps/Chunk64.dita#topic_qft_qwn_hv"));
    b.put(prefixTemp("maps/topics/153.dita"), prefixTemp("maps/Chunk64.dita#unique_65"));
    b.put(
        prefixTemp("maps/topics/153.dita#topic_qft_qwn_hv"),
        prefixTemp("maps/Chunk64.dita#unique_65"));
    ...
    b.put(
        prefixTemp("maps/topics/154.dita#topic_qft_qwn_hv"),
        prefixTemp("maps/155.dita#topic_qft_qwn_hv"));
    ...
    b.put(
        prefixTemp("maps/topics/157.dita#topic_qft_qwn_hv"),
        prefixTemp("158.dita#topic_qft_qwn_hv"));
    ...
    b.put(
        prefixTemp("maps/topics/160.dita#topic_qft_qwn_hv"),
        prefixTemp("maps/topics/161.dita#topic_qft_qwn_hv"));
    b.put(prefixTemp("topics/162.dita"), prefixTemp("maps/topics/161.dita#unique_68"));
    b.put(
        prefixTemp("topics/162.dita#topic_qft_qwn_hv"),
        prefixTemp("maps/topics/161.dita#unique_68"));
    ...
    b.put(
        prefixTemp("maps/topics/163.dita#topic_qft_qwn_hv"),
        prefixTemp("topics/164.dita#topic_qft_qwn_hv"));
    ...
    b.put(
        prefixTemp("maps/topics/166.dita#topic_qft_qwn_hv"),
        prefixTemp("maps/Chunk70.dita#topic_qft_qwn_hv"));
    b.put(prefixTemp("topics/167.dita"), prefixTemp("maps/Chunk70.dita#unique_71"));
    b.put(
        prefixTemp("topics/167.dita#topic_qft_qwn_hv"), prefixTemp("maps/Chunk70.dita#unique_71"));
    ...
    b.put(
        prefixTemp("topics/168.dita#topic_qft_qwn_hv"),
        prefixTemp("maps/169.dita#topic_qft_qwn_hv"));
    ...
    b.put(
        prefixTemp("topics/174.dita#topic_qft_qwn_hv"),
        prefixTemp("maps/topics/175.dita#topic_qft_qwn_hv"));
    b.put(prefixTemp("maps/176.dita"), prefixTemp("maps/topics/175.dita#unique_74"));
    b.put(
        prefixTemp("maps/176.dita#topic_qft_qwn_hv"), prefixTemp("maps/topics/175.dita#unique_74"));
    ...
    b.put(
        prefixTemp("topics/177.dita#topic_qft_qwn_hv"),
        prefixTemp("topics/178.dita#topic_qft_qwn_hv"));
    ...
    b.put(
        prefixTemp("topics/180.dita#topic_qft_qwn_hv"),
        prefixTemp("maps/Chunk76.dita#topic_qft_qwn_hv"));
    ...
    b.put(
        prefixTemp("topics/182.dita#topic_qft_qwn_hv"),
        prefixTemp("maps/183.dita#topic_qft_qwn_hv"));
    ...
    b.put(
        prefixTemp("topics/188.dita#topic_qft_qwn_hv"),
        prefixTemp("maps/topics/189.dita#topic_qft_qwn_hv"));
    ...
    b.put(
        prefixTemp("topics/191.dita#topic_qft_qwn_hv"),
        prefixTemp("topics/192.dita#topic_qft_qwn_hv"));
    ...
    b.put(
        prefixTemp("topics/194.dita#topic_qft_qwn_hv"),
        prefixTemp("maps/Chunk82.dita#topic_qft_qwn_hv"));
    ...
    b.put(
        prefixTemp("topics/196.dita#topic_qft_qwn_hv"),
        prefixTemp("maps/197.dita#topic_qft_qwn_hv"));
    b.put(prefixTemp("maps/topics/198.dita"), prefixTemp("maps/197.dita#unique_84"));
    b.put(
        prefixTemp("maps/topics/198.dita#topic_qft_qwn_hv"), prefixTemp("maps/197.dita#unique_84"));
    ...
    b.put(
        prefixTemp("topics/202.dita#topic_qft_qwn_hv"),
        prefixTemp("maps/topics/203.dita#topic_qft_qwn_hv"));
    b.put(prefixTemp("maps/topics/204.dita"), prefixTemp("maps/topics/203.dita#unique_86"));
    b.put(
        prefixTemp("maps/topics/204.dita#topic_qft_qwn_hv"),
        prefixTemp("maps/topics/203.dita#unique_86"));
    ...
    b.put(
        prefixTemp("topics/205.dita#topic_qft_qwn_hv"),
        prefixTemp("topics/206.dita#topic_qft_qwn_hv"));
    b.put(prefixTemp("maps/topics/207.dita"), prefixTemp("topics/206.dita#unique_87"));
    b.put(
        prefixTemp("maps/topics/207.dita#topic_qft_qwn_hv"),
        prefixTemp("topics/206.dita#unique_87"));
    ...
    b.put(
        prefixTemp("topics/208.dita#topic_qft_qwn_hv"),
        prefixTemp("maps/Chunk88.dita#topic_qft_qwn_hv"));
    b.put(prefixTemp("maps/topics/209.dita"), prefixTemp("maps/Chunk88.dita#unique_89"));
    b.put(
        prefixTemp("maps/topics/209.dita#topic_qft_qwn_hv"),
        prefixTemp("maps/Chunk88.dita#unique_89"));
    ...
    b.put(
        prefixTemp("topics/210.dita#topic_qft_qwn_hv"),
        prefixTemp("maps/211.dita#topic_qft_qwn_hv"));
    ...
    b.put(
        prefixTemp("topics/216.dita#topic_qft_qwn_hv"),
        prefixTemp("maps/topics/217.dita#topic_qft_qwn_hv"));
    b.put(prefixTemp("topics/218.dita"), prefixTemp("maps/topics/217.dita#unique_92"));
    b.put(
        prefixTemp("topics/218.dita#topic_qft_qwn_hv"),
        prefixTemp("maps/topics/217.dita#unique_92"));
    ...
    b.put(
        prefixTemp("topics/219.dita#topic_qft_qwn_hv"),
        prefixTemp("topics/220.dita#topic_qft_qwn_hv"));
    ...
    b.put(
        prefixTemp("topics/222.dita#topic_qft_qwn_hv"),
        prefixTemp("maps/Chunk94.dita#topic_qft_qwn_hv"));
    b.put(prefixTemp("topics/223.dita"), prefixTemp("maps/Chunk94.dita#unique_95"));
    b.put(
        prefixTemp("topics/223.dita#topic_qft_qwn_hv"), prefixTemp("maps/Chunk94.dita#unique_95"));
            ...
            .select(
                Steps.descendant(
                    TOPIC_XREF
                        .matcher()
                        .and(
                            Predicates.attributeEq(
                                ATTRIBUTE_NAME_HREF, "chunkedTopic.dita#subtopic3"))))
            .exists());
