...
public class ProcessorTest {
  ...
  @Rule public final TemporaryFolder tempDirGenerator = new TemporaryFolder();
  ...
  public void testRun() throws DITAOTException, IOException, URISyntaxException {
    final File mapFile =
        new File(getClass().getClassLoader().getResource("ProcessorTest/test.ditamap").toURI());
  ...
  public void testBroken() throws DITAOTException, IOException, URISyntaxException {
    final File mapFile =
        new File(getClass().getClassLoader().getResource("ProcessorTest/broken.dita").toURI());
    final File out = tempDirGenerator.newFolder("out");
    try {
