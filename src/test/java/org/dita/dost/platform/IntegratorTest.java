...
public class IntegratorTest {
  ...
  public void testExecute() throws Exception {
    ...
    final Properties expProperties =
        getProperties(
            new File(
                expDir,
                "lib"
    ...
    expProperties.setProperty(
        "plugin.org.dita.base.dir", new File("plugins/org.dita.base").getPath());
    expProperties.setProperty("plugin.base.dir", "plugins/base");
    expProperties.setProperty("plugin.dummy.dir", "plugins/dummy");
    final Properties actProperties =
        getProperties(
            new File(
                tempDir,
                "config"
    ...
    assertEquals(
        new HashSet<>(
            Arrays.asList(expProperties.getProperty(CONF_SUPPORTED_IMAGE_EXTENSIONS).split(";"))),
        new HashSet<>(
            Arrays.asList(expProperties.getProperty(CONF_SUPPORTED_IMAGE_EXTENSIONS).split(";"))));
    ...
    assertXMLEqual(
        ...
        new InputSource(
            new File(tempDir, "xsl" + File.separator + "shell.xsl").toURI().toString()));
    assertXMLEqual(
        new InputSource(
            new File(
                    expDir,
