...
public class StreamStoreTest {
  ...
  public void copy_WhenFileExists_ShouldCreateCopy() throws IOException {
    ...
    store.copy(
        tmpDir.toPath().resolve("src.xml").toUri(), tmpDir.toPath().resolve("dst.xml").toUri());
  ...
  @Test
  public void transformWithAnchorInURIPath()
      throws IOException, DITAOTException, URISyntaxException {
