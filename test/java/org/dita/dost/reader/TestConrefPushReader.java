...
public class TestConrefPushReader {
    ...
    private static final File resourceDir = new File("test-stub", TestConrefPushReader.class.getSimpleName());
	...
	public void testRead(){
         ...
         *	</steps>
		 */
		File filename = new File(srcDir, "conrefpush_stub.xml");
		...
		if (it.hasNext()){
		    ...
		    Hashtable<String, String> table = it.next().getValue();
