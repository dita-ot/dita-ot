...
<xsl:template name="musicGetString">
  ...
  <xsl:call-template name="getString">
    ...
    <!--<xsl:with-param name="plugin" select="'music'"/>-->
...
<xsl:template match="*[contains(@class,' musicCollection/cdHeader ')]" name="topic.reference.musicCollection.cdHeader">
  ...
  <tr>
   ...
   <xsl:value-of select="$newline"/>
     ...
     <xsl:choose>      
       <xsl:when test="*[contains(@class,' musicCollection/bandHeader ')]">
         <xsl:apply-templates select="*[contains(@class,' musicCollection/bandHeader ')]">
           <xsl:with-param name="width-multiplier"><xsl:value-of select="$width-multiplier"/></xsl:with-param>
         </xsl:apply-templates>
       </xsl:when>
       <xsl:when test="following-sibling::*/*[contains(@class,' musicCollection/band ')]">
         <th valign="bottom">
           <xsl:call-template name="th-align"/>
           <xsl:attribute name="id"><xsl:value-of select="generate-id(parent::*)"/>-band</xsl:attribute>
           <xsl:call-template name="musicGetString">
   ...
   <xsl:value-of select="$newline"/>
     ...
     <xsl:choose>      
       <xsl:when test="*[contains(@class,' musicCollection/band ')]">
         <xsl:apply-templates select="*[contains(@class,' musicCollection/band ')]">
           <xsl:with-param name="width-multiplier"><xsl:value-of select="$width-multiplier"/></xsl:with-param>
         </xsl:apply-templates>
       </xsl:when>
       <xsl:when test="../*/*[contains(@class,' musicCollection/band ')] | ../*[1]/*[contains(@class,' musicCollection/bandHeader ')]">
         <td>    <!-- Create an empty cell. Add accessiblity attribute. -->
           <xsl:call-template name="addMusicHeaders">
             <xsl:with-param name="classVal"> musicCollection/bandHeader </xsl:with-param>
...
<xsl:template match="*[contains(@class,' musicCollection/band ')]">
